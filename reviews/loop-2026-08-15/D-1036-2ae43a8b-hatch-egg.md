...
| 4 `get_obj_location` flags `0` vs CONTAINED | **Addressed:** D-1054 `3f8469fe` |
...
4. JS `get_obj_location` flags `0`: if the implementation accepts CONTAINED, C does not. **Addressed:** D-1054 `3f8469fe`
