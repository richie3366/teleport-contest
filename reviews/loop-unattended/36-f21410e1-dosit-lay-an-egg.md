...
2. `clone_mon` monster `split_mon` **Addressed:** D-1078 `c7dcd80a`. Wizard getlin **Addressed:** D-1084 `83a3ada5`. `shieldeff` body **Addressed:** D-1087 `d5038ac7`; sit `Antimagic` uprops is review **48** Must-fix. Do not pull them into `is_lava`.
