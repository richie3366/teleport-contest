...
2. Helper `ceiling_hider` / `MZ_HUGE` / `uteetering` / `uescaped_shaft`; `Flying` sticky vs `youprop.h` (not live at `dosit`+`FALSE`). **Addressed:** D-1082 `453e759c` / D-1083 `e6167027` / D-1085 `3e1a74e8` (`uprops[FLYING]`).
