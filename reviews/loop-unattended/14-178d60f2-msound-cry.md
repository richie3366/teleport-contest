...
Named omits (map, not queue): `peace_minded`/`set_malign` **Addressed:** D-1079 `d7d679c1`; `m_initweap` priest/guardian **Addressed:** D-1088 `049af16e`; MS_NEMESIS mitem **Addressed:** D-1094; `domonnoise` isshk/guardian/orc/moo/gecko; `dogmove` pal/target **Addressed:** D-1093 `e0b68f1d`; leftover `mon_msound` mlet infer for stubs.
