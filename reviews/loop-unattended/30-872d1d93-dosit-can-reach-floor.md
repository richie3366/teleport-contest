...
Named omits (map / Open, not Must-fix): ustuck `!sticks` lap (`sit.c:422–429`) **Addressed:** D-1072 `55906000`; helper hugs **Addressed:** D-1071 `aa96e08c`; `ceiling_hider` / `MZ_HUGE` **Addressed:** D-1082 `453e759c`; `uteetering` / `uescaped_shaft` **Addressed:** D-1083 `e6167027`; `Flying` vs `uprops[FLYING]` **Addressed:** D-1085 `3e1a74e8`; wizard getlin **Addressed:** D-1084 `83a3ada5`; `lay_an_egg` **Addressed:** D-1075 `f21410e1`.
