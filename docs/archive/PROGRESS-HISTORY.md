...
Living score/objective: `docs/CURRENT.md`.
This file is append-only archaeology — do **not** read by default.
...
| `seed0030-ten-diverse-deaths` | **48104 / 105529** | **85 / 1953** |
...
open-door (D-0111/D-0112/D-0113) → **PASS**. seed0030 **48104**/105529.
