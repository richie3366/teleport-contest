...
- [x] `muse.c` buzzmu real zap path — `lined_up` + `rn2(3)` + buzz pline/effects (named D-2233; stub still returns MISS). No corpus block — port the named path. Probe: `node scripts/brief.mjs buzzmu`. **Addressed:** D-2252
