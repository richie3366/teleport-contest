...
`30+0.25/turn`. Next cadence @**#1170**. (#1166 focused seed4500
prefix @1048→@1053; Scr **1413**/1814 — suite score not remeasured.)
...
| seed4500 | **108275**/108275 | 1413/1814 | knight; @1053 wield/carrots |
...
**seed4500 @1053** — after wielding Sword of Justice (@1052 OK), C
topline `h - 11 uncursed carrots (alternate weapons; not wielded)` vs
JS `It bites!…`. JS `uswapwep` is null at that boundary; likely missing
ready_weapon / swap prinv after replacing carrots. Focused:
...
**Keep:** D-0845…D-0927; D-0928 #1119–#1166; teleds placebc (#1151);
...
ICE typ / feel_location-only (was unmap_object). Recent rejects:
@1048≠ICE typ — DEC ROOM `~` + stale obj memory after thin-air
fight_empty (#1166); @1034≠C-empty — invent caller pline + missing
