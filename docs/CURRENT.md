...
revisits the picker.
**Next cluster:** `shk.c` block_entry — coverage MISSING (C 32 L `shk.c:5826–5858` / JS no symbol; hops 3, callers 1, RNG 0, msg 1). Verify `node scripts/verify.mjs --fn block_entry` (reach regression must be 0).
