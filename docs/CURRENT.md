...
absent.md thin systems or other debt.md clusters under fortress.
...
**Do not re-break D-0660…D-0978. Do not FORCE CLOSE/movement/umov /
...
**D-0955**…**D-0978** (revive/Ring_gone/grave/shopdig/bridge/
...
`ignite_items`/`catch_lit`/`begin_burn`/`burn_away_slime` — do not re-stub).
