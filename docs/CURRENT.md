...
**Gameplay next:** seed0108 @3186 — D-0717 `set_mon_data` prorated
hero `umovement` on slower poly (wizard→gnome→6 kept through dragon).
Prefix **3011→3186**. Next: C `newman` `rn2(10)` vs JS `rn2(6)`
(rehumanize). Or seed0014 @49039 **D-0708.** Prefer shared blockers.
seed2200 @158 parked. Do **not** re-break D-0660…D-0717.
