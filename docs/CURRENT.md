...
**Next cluster:** globby `pudding_merge`/`obj_meld`; or
`sellobj`/`check_shop_obj` throw-land bill; or barefoot petrify /
tmp_at flash; or absent.md thin systems under fortress
...
**Do not re-break D-0660…D-0992. Do not FORCE CLOSE/movement/umov /
...
**D-0955**…**D-0992** (… ship_object + kick_nondoor furniture +
...
+ fire_damage/doaltarobj/hot potion — do not re-stub).
