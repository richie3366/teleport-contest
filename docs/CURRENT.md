...
**Next cluster:** `mon.c` can_be_hatched body (data.md:269 EGG can_be_hatched multi-retry; never own-row live/archived/parked). Probe: `node scripts/brief.mjs can_be_hatched`.
