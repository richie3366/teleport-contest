...
revisits the picker.
**Next cluster:** `trap.c` `help_monster_out` — coverage PARTIAL. Verify `node scripts/verify.mjs --fn help_monster_out`.
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2833 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2833; wrap `wildmiss` /
