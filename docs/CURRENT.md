...
**Do not re-break D-0660…D-0976. Do not FORCE CLOSE/movement/umov /
...
**D-0955**…**D-0976** (revive/Ring_gone/grave/shopdig/bridge/
...
lavawall spines + burn feedback / `dosinkfall` — do not re-stub).
