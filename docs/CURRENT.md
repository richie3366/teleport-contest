...
**Gameplay next:** seed0014 @22868 C `dog_move` `rn2(12)`
(dogmove.c:1257) vs JS `rn2(24)`. D-0693 thitmonst pie DEX→hmon
(prefix 22582→22868, Scr 481→482). Or seed0108 wishlist @2772.
