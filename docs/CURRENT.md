...
**Next cluster:** Open `uhitm.c` erode_armor — 1 corpus block RNG-first at step 47 (C `rn2(5)` in erode_armor vs JS `rn2(3)` mhitm_knockback; tour-Healer-70025-d5-8-15-17-22; unblocked by the climb_pit port above).
**Open stays hidden-score ordered** (`PORT-GAP-TOP30.md`).
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-1883 (index).** Recent **D-1820:** `makemaz` `soko2-2`
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-1883; wrap `wildmiss` /
