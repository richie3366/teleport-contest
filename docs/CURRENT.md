...
in the D-2679…D-2693 window (9 ACCEPTs;
...
revisits the picker.
**Next cluster:** queue head `spell.c` percent_success — coverage PARTIAL (C 119 L `spell.c:2173–2292` / JS 80 L in js/spell.js; hops 6, callers 3, RNG 0, msg 0). Port the whole C body in C order — every arm, every callee live or named in the map, every C caller wired. Verify `node scripts/verify.mjs --fn percent_success` (reach regression must be 0). Measured `port-coverage.mjs --name percent_success` 2026-09-20 @ 40ce1e84.
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2693 (index).**
<!-- recent:begin -->
**D-2693**  — 
**D-2692**  — 
**D-2691**  — 
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2693; wrap `wildmiss` /
