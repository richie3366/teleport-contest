...
in the D-2574…D-2584 window, all worktree-bisected: Rogue-92026 → D-2574
...
revisits the picker.
**Next cluster:** `objnam.c` Master-Key wish regression (D-2577 Must-fix, review 1536) — scen-wish-Priest-92163 + scen-wish-Rogue-92221 (owner next_ident mkobj.c:521): ported the postparse1 six-prefix corpse-scan skip (C `:4399–4404`) so the Master Key wish reaches `artifact_name` → blast. Verify `score --ids scen-wish-Priest-92163,scen-wish-Rogue-92221` → both PASS.
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2584 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2584; wrap `wildmiss` /
