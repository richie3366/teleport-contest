...
`init_uhunger` named in `startup.md`. `hatch_egg` still deferred
in timeout.
...
**D-0948**…**D-1034** (zap/dig/eat/shop/kick/paranoid/allmain/
...
D-0983…D-1034 clusters already Keep’d above.
