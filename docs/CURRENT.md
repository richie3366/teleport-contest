...
|--------|----:|-------:|------|
| seed0116 | 12336/12562 | **110**/127 | D-0520; next fill_zoo tail / `place_lregion` @12294 |
...
**Gameplay next:** after D-0520 `soko1-1`, peel fill_zoo irregular/
door-adjacent cell filter after flip (seed0116 @12294 `place_lregion`
vs extra JS gold), Bar-strt `selection_do_randline` (seed0373 @3289),
or seed5006 `dosounds` @8468. Prefer shared special/fill_zoo over
parked seed2200 RC.
...
**Prefer over:** parked D-0006, seed2200 RC; re-opening D-0474…D-0520.
