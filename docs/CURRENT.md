...
**Suite 44/44** at **D-1822**. Map-driven Open.
**Next cluster:** `mkmaze.c` makemaz `minend-3` — third Mine's End
variant; 33% blank → 0%. From `dat/minend-3.lua` (107 ln).
Save-oracle for tagged restore Open (`save-oracle.mjs probe --omit`).
**Open stays hidden-score ordered** (`PORT-GAP-TOP30.md`).
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-1822 (index).** Recent **D-1820:** `makemaz` `soko2-2`
...
<!-- recent:end -->
**Do not:** FORCE/RNG; skip D-1229…D-1822; wrap `wildmiss` /
