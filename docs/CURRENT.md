...
Reviews **827–834** (D-1857…D-1866): 5 ACCEPT, 2 ACCEPT-WITH-DEBT,
...
**Next cluster:** Open `do_wear.c` menu_remarm — 2 corpus blocks screen-first (`,` SELECT_PAGE selects SKIPINVERT `a - All worn…` in JS; C skips via `menuinvertmode=1`).
Save-oracle for tagged restore Open (`save-oracle.mjs probe --omit`).
**Open stays hidden-score ordered** (`PORT-GAP-TOP30.md`).
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-1866 (index).** Recent **D-1820:** `makemaz` `soko2-2`
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-1866; wrap `wildmiss` /
