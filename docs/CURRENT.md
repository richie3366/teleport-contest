...
**Next cluster:** `kick_object` + `bhit` KICKED_WEAPON (flooreffects
via D-0987); or absent.md thin systems under fortress (potion/scroll
thin; vault polish); or remaining flooreffects arms (`fire_damage` /
globby / altar / hot potion).
...
**Do not re-break D-0660…D-0987. Do not FORCE CLOSE/movement/umov /
...
**D-0955**…**D-0987** (… ship_object + kick_nondoor furniture +
throne/`fall_through`/tree + flooreffects pool/lava/pit — do not
re-stub).
...
re-stub `flooreffects` drop/throw (D-0987).
