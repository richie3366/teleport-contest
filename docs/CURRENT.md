...
Score last measured: **2026-07-16** — full `sessions` suite (loop **#540**).
Screens **5014**/11405; RNG **289809**/792838 (36.55%).
**28/44** PASS. Speed `24+0.14/turn`. Δ vs #535: Scr **0**, PASS **28→28**,
RNG **0**, speed label noise only.
...
| seed0007 | 6526/16373 | **20**/302 | snake swamp; RNG peel @6414 eatcorpse |
...
**Gameplay next:** seed0007 rogue snake swamp — **D-0487** fixed (RNG
**3219→6414**): locked-door autoopen → autounlock/`picklock` occupation.
**D-0488** (open): @6414 C `rn2(20) @ eatcorpse` vs JS `rn2(7)`. Scr still
**20**/302.
...
**Prefer over:** parked D-0006, seed2200 RC; re-opening D-0474…D-0487.
