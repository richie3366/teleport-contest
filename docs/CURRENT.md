...
**Next cluster:** apply.js `use_candle` / `use_candelabrum` (`debt.md`).
D-1024 flip_book/flip_coin is Keep’d. Grease still named in apply
debt; remaining nhl_gamestate memcpy u/disco/mvitals/spl_book +
`init_uhunger` named in `startup.md`.
...
**Do not re-break D-0660…D-1024. Do not FORCE CLOSE/movement/umov /
peace_minded / ualign / pet malign / shk satdoor/`onlineu` (D-0376).
**Do not re-apply D-0480 glyph `tty_map_color` in serialize (D-0483).**
**Keep:** D-0845…D-0927; D-0928 #1119–#1194; D-0929…D-0947;
**D-0948**…**D-1024** (zap/dig/eat/shop/kick/paranoid/allmain/
...
D-0983…D-1024 clusters already Keep’d above.
