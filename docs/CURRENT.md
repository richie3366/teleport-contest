...
`mkobj_at(FOOD_CLASS)` `rnd(1000)` — veggy shop stand-in). Focused:
...
**Do not re-break D-0660…D-0901. Do not FORCE CLOSE/movement/umov.**
...
D-0861…D-0901 (searches_for_item … Pillars terr).
