...
Score last measured: **2026-07-23** — full `sessions` after **D-1015**
(**44**/44, Scr **11405**/11405, RNG **100%**). Speed `33+0.27/turn`
(R² 0.868). Next cadence @**#1290**.
...
**Next cluster:** D-1018 `use_pick_axe` cmdq wield re-apply (C queues
`doapply`+invlet; JS pushes `{typ:'ec'}` and `getobj_apply` ignores
canned keys). Then D-1019 `sellobj` default `'a'` / C `robbed`
precedence; D-1020 `setnotworn` pointer-walk + leave-tutorial. Do
**not** pick `absent.md` / whip until those C-wrong Keeps are fixed.
D-1018–D-1020 correct already-Keep’d functions — that is not a re-stub.
...
**Do not re-break D-0660…D-1017. Do not FORCE CLOSE/movement/umov /
peace_minded / ualign / pet malign / shk satdoor/`onlineu` (D-0376).
**Do not re-apply D-0480 glyph `tty_map_color` in serialize (D-0483).**
**Keep:** D-0845…D-0927; D-0928 #1119–#1194; D-0929…D-0947;
**D-0948**…**D-1017** (zap/dig/eat/shop/kick/paranoid/allmain/
...
snatch polarity** + **`cancel_monst` hero invent Array walk** — do not
re-stub).
...
D-0983…D-1017 clusters already Keep’d above.
