...
revisits the picker.
**Next cluster:** shipped — `invent.c` doorganize_core → **D-2618** (row archived with `**Addressed:** D-2618`; next iteration pops the live head).
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2618 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2618; wrap `wildmiss` /
