...
in the D-2592…D-2602 window (all 9 ports coverage-only; every per-SHA
...
revisits the picker.
**Next cluster:** `insight.c` fmt_elapsed_time — coverage MISSING (C 44 L `insight.c:314–358` / JS no symbol; hops 5, callers 1, RNG 0, msg 3). Measured `port-coverage.mjs --name fmt_elapsed_time` 2026-09-20 @ d89bb259.
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2602 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2602; wrap `wildmiss` /
