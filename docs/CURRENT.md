...
**#1395** (**44**/44, Scr **11405**/11405, RNG **100%**).
Speed `31+0.27/turn` (R² 0.87). Next audit (review + score) @**#1400**.
...
**Next cluster:** `teleport.c` `goodpos` `passes_walls` + `may_passwall` early-out. Not youmonst swim.

**Density:** one C family (~50–300 lines). §2a–2b.

**Parked:** D-0006 only. **Do not re-break D-0660…D-1099. Do not FORCE CLOSE/movement/umov /
peace_minded / ualign / pet malign / shk satdoor/`onlineu` (D-0376).
**Do not re-apply D-0480 glyph `tty_map_color` in serialize (D-0483).**
**Keep:** D-0845…D-0927; D-0928 #1119–#1194; D-0929…D-0947;
**D-0948**…**D-1099** (zap/dig/eat/shop/apply through
...
DRAWBRIDGE_UP+`DB_LAVA` D-1077; `clone_mon` D-1078; msound D-1079; D-1080–D-1098).
...
no restore `is_lava`/`is_pool` LAVAPOOL/POOL-only (D-1077/D-1090); no restore `goodpos` typ macros (D-1091); no restore youmonst `goodpos` pool/lava to monster `is_swimmer`/`m_in_air` only (D-1099); no restore `split_mon` monster null (D-1078); no skip D-1095 split_mon callers; no skip peace/malign `msound` (D-1079); no skip D-1080–D-1099; no restore priest/guardian mndx (D-1088) / neminum mitem (D-1094); no steal setworn-only unwear; no skip `mineralize` `In_endgame` before kelp; no WATER kelp
