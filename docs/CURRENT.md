...
to the prior audit, no flips across D-2503…D-2518 (per-SHA re-runs:
0 regressed).
...
revisits the picker.
**Next cluster:** `uhitm.c` mhitm_ad_drli — coverage THIN (C 71 L `uhitm.c:2445–2518`; split-live: mhitm arm js/mhitm.js:3717, uhitm arm js/uhitm.js:1967, mhitu arm js/mhitu.js:2579; gap: defended(AD_DRLI) disjunct — C mondata.c:210 tail missing from resists_drli + uhitm caller).
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2518 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2518; wrap `wildmiss` /
