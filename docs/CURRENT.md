...
in the D-2628…D-2638 window (7 ACCEPTs + 1 QUALITY-RISK;
...
revisits the picker.
**Next cluster:** `hack.c` avoid_trap_andor_region (walkfrom STALE, add_erosion_words dupe).
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2638 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2638; wrap `wildmiss` /
