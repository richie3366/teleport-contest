...
**Gameplay next:** **seed4500** @50338 (C `distfleeck` `rn2(5)` vs
  JS `rn2(3)` — after D-0912 `#turn`/`doturn`). Focused:
...
**Do not re-break D-0660…D-0912. Do not FORCE CLOSE/movement/umov.**
...
D-0861…D-0912 (searches_for_item … `#turn`/`doturn`).
