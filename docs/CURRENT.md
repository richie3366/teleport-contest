...
**Gameplay next:** seed0367 — first RNG miss @2336: C `getbones`
`rn2(3)` then nhlib `shuffle` vs JS `rn2(79)`. Prefix **2336** after
D-0636 (blue DSM Very_fast). Prefer over parked D-0006 / seed2200 RC;
do not reopen D-0474…D-0636.
