...
in the D-2670…D-2681 window (9 ACCEPTs;
...
revisits the picker.
**Next cluster:** `role.c` rigid_role_checks — coverage PARTIAL (C 46 L `role.c:1235–1281` / JS 33 L in js/player_selection.js; hops —, callers 2, RNG 0, msg 0). Port the whole C body in C order — every arm, every callee live or named in the map, every C caller wired. Verify `node scripts/verify.mjs --fn rigid_role_checks` (reach regression must be 0). Measured `port-coverage.mjs --name rigid_role_checks` 2026-09-20 @ 4307ede7.
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2681 (index).**
<!-- recent:begin -->
**D-2681**  — 
**D-2680**  — 
**D-2679**  — 
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2681; wrap `wildmiss` /
