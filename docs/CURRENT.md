...
**Next cluster:** sit.c `special_throne_effect` grease spray (named
with `grease_ok` COIN skip). Remaining nhl_gamestate memcpy
u/disco/mvitals/spl_book + `init_uhunger` named in `startup.md`.
`hatch_egg` still deferred in timeout.
...
**Do not re-break D-0660…D-1032. Do not FORCE CLOSE/movement/umov /
peace_minded / ualign / pet malign / shk satdoor/`onlineu` (D-0376).
**Do not re-apply D-0480 glyph `tty_map_color` in serialize (D-0483).**
**Keep:** D-0845…D-0927; D-0928 #1119–#1194; D-0929…D-0947;
**D-0948**…**D-1032** (zap/dig/eat/shop/kick/paranoid/allmain/
...
D-0983…D-1032 clusters already Keep’d above.
