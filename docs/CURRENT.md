...
in the D-2636…D-2646 window (9 ACCEPTs;
...
revisits the picker.
**Next cluster:** `objnam.c` singplur_lookup — coverage MISSING (C 68 L `objnam.c:2708–2779` / JS no symbol).
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2646 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2646; wrap `wildmiss` /
