...
to the prior audit, no flips across D-2503…D-2515 (per-SHA re-runs:
0 regressed).
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2515; wrap `wildmiss` /
