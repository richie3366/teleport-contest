...
(potion/scroll/vault polish); or allmain Teleportation /
Polymorph / ulycn once-per-turn (`you_were` wired D-1001).
...
**Do not re-break D-0660…D-1001. Do not FORCE CLOSE/movement/umov /
...
**D-0955**…**D-1001** (… ParanoidWerechange/Hit / you_were — do not re-stub).
