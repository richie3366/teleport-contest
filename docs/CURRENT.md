...
**Map-driven fortress** after D-1316. Reviews **273–276**:
**273/274/276** ACCEPT-WITH-DEBT; **275** QUALITY-RISK (caller now
wired).
**Next cluster:**
Open `objnam.c` doname CANDELABRUM (n of 7) (named from D-1308). Not
candle.
Do not skip D-1316…D-1229 (index). Keep mention_map addr. Do not wrap
...
**Parked:** D-0006. **Do not re-break D-0660…D-1316.** Do not FORCE
CLOSE/movement/umov / shk satdoor/`onlineu` (D-0376).
**Do not re-apply D-0480 glyph `tty_map_color` in serialize (D-0483).**
**Keep:** D-0845…D-1316 (index). Recent: **D-1316** `dothrow.c`
throwit ACURRSTR urange. Prior: **D-1315** throwit →
`throwit_mon_hit`. D-1314 `mon.c` `m_respond`. D-1313
...
spaces; wrap `wildmiss` / `msg_mon_movement` as `pline_mon`; skip D-1229…D-1316
