...
| seed0361 | 31644/53865 | 289/366 | @31644 C nhl shuffle vs JS rn2(79) |
...
**Gameplay next:** seed0361 @31644 — C nhlib `shuffle` `rn2(3)` after
matched `getbones` vs JS `rn2(79)` (post D-0617 tower1 candles). Or
seed0367 `Pri-strt`, seed0014/0108. Prefer over parked D-0006 /
seed2200 RC; do not reopen D-0474…D-0617.
