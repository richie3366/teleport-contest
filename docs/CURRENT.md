...
in the D-2661…D-2675 window (9 ACCEPTs;
...
revisits the picker.
**Next cluster:** `wield.c` doswapweapon — coverage PARTIAL (C 40 L `wield.c:461–501` / JS 29 L in js/wield.js; hops —, callers 2, RNG 0, msg 2). Port the whole C body in C order — every arm, every callee live or named in the map, every C caller wired. Verify `node scripts/verify.mjs --fn doswapweapon` (reach regression must be 0). Measured `port-coverage.mjs --name doswapweapon` 2026-09-20 @ f0550a81.
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2675 (index).**
<!-- recent:begin -->
**D-2675**  — 
**D-2674**  — 
**D-2673**  — 
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2675; wrap `wildmiss` /
