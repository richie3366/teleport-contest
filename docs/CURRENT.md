...
**Next cluster:** Open — `sit.c` `rndcurse` `shieldeff` (named omit). Not update_inventory / hcolor. Audit @**#1385**.

**Iteration density:** one C family (~50–300 lines). Prefer delete-wrong-JS + re-port. Playbook §2a–2b.

**Parked:** D-0006 only. **Do not re-break D-0660…D-1086. Do not FORCE CLOSE/movement/umov /
peace_minded / ualign / pet malign / shk satdoor/`onlineu` (D-0376).
**Do not re-apply D-0480 glyph `tty_map_color` in serialize (D-0483).**
**Keep:** D-0845…D-0927; D-0928 #1119–#1194; D-0929…D-0947;
**D-0948**…**D-1086** (zap/dig/eat/shop/kick/allmain/apply through
...
DRAWBRIDGE_UP+`DB_LAVA` D-1077; `clone_mon` D-1078; msound D-1079; D-1080–D-1086).
...
no restore `is_lava` LAVAPOOL-only (D-1077); no restore `split_mon` monster null (D-1078); no skip peace/malign `msound` (D-1079); no skip D-1080–D-1086; no steal setworn-only unwear; no skip `mineralize` `In_endgame` before kelp; no WATER kelp
