...
thin; vault polish); or dopay appease arms; or apply camera/
ParanoidBreakwand.
...
**Do not re-break D-0660…D-0997. Do not FORCE CLOSE/movement/umov /
...
**D-0955**…**D-0997** (… animate_statue/activate_statue_trap/Blind
kick feel — do not re-stub).
