...
`begin_burn` prerequisites as needed); release_hold WAN_OPENING /
flash_hits.
...
**Do not re-break D-0660…D-0977. Do not FORCE CLOSE/movement/umov /
...
**D-0955**…**D-0977** (revive/Ring_gone/grave/shopdig/bridge/
...
passtune + open/close_drawbridge — do not re-stub).
