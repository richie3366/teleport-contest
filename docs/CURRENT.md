...
Score last measured: **2026-09-06** — full `sessions` at **D-1943**
(audit **905–913**, `82cffe79`). Fortress held 44/44: seed0030
**D-1816**, seed4500 `#wizintrinsic` deafness `[2]` **D-1817**. Scr
**11,405**/11,405, RNG **792,838**/792,838. Speed `70+0.49/turn`
(R² 0.84).
...
| Speed label | `70+0.49/turn` (R² 0.84) |
...
Reviews **854–862** (D-1884…D-1944):
8 ACCEPT, 1 QUALITY-RISK (Cav wallify Must-fix, queued). Reviews
**863–870** (D-1893…D-1944): 7 ACCEPT, 1 QUALITY-RISK
(`domindblast` gaze blocks Must-fix, queued). Reviews **871–878**
(D-1901…D-1944): 7 ACCEPT, 1 QUALITY-RISK (`Inhell_pager`
hellish-flag Must-fix, queued). Reviews **879–887**
(D-1909…D-1944): 8 ACCEPT, 1 QUALITY-RISK (lava Wwalking
Must-fix, queued). Reviews **888–895** (D-1918…D-1944):
...
**905–913** (D-1935…D-1944): 9 ACCEPT, 0 Must-fix.
...
**Next cluster:** `sp_lev.c` lspo_* + selvar selection primitives (HELDOUT Tier C misc row remainder; no JS symbol). Focus: nhlsel `l_selection_sub`/`l_selection_xor` + selvar `selection_clear`/`selection_recalc_bounds` (Tou-goal.lua:112 / Tou-loca.lua:131 `-` operator; JS and+not workaround).
**Open stays hidden-score ordered** (`PORT-GAP-TOP30.md`).
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-1944 (index).** Recent **D-1820:** `makemaz` `soko2-2`
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-1944; wrap `wildmiss` /
