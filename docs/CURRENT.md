...
**Next cluster:** Is_box kick arms / `ghitm` / `hits_bars` polish on
kick path; or remaining flooreffects arms (`fire_damage` / globby /
...
**Do not re-break D-0660…D-0988. Do not FORCE CLOSE/movement/umov /
...
**D-0955**…**D-0988** (… ship_object + kick_nondoor furniture +
