...
in the D-2610…D-2619 window (8 ACCEPTs + 1 WITH-DEBT;
...
revisits the picker.
**Next cluster:** shipped — `botl.c` get_hilite → **D-2619** (row archived with `**Addressed:** D-2619`; next iteration pops the live head).
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2619 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2619; wrap `wildmiss` /
