...
**Next cluster:** `db_under_typ` / `waterbody_name` SURFACE_AT. Not `goodpos`.

**Density:** one C family (~50–300 lines). §2a–2b.

**Parked:** D-0006 only. **Do not re-break D-0660…D-1102. Do not FORCE CLOSE/movement/umov /
peace_minded / ualign / pet malign / shk satdoor/`onlineu` (D-0376).
**Do not re-apply D-0480 glyph `tty_map_color` in serialize (D-0483).**
**Keep:** D-0845…D-0927; D-0928 #1119–#1194; D-0929…D-0947;
**D-0948**…**D-1102** (zap/dig/eat/shop/apply through
...
DRAWBRIDGE_UP+`DB_LAVA` D-1077; D-1078–D-1102).
