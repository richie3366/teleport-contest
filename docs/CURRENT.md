...
| seed0373 | 14774/35386 | 22/124 | D-0537; next `rndmonst_adj` @14748 |
...
**Gameplay next:** after D-0537 (`mineralize` In_quest probs),
seed0373 @14748 C `rndmonst_adj` `rn2(7)` vs JS `rnd(4)` after
matched `traptype_rnd`. Or peel seed5006 `dosounds` @8468. Prefer
over parked seed2200 RC / seed0116 screen residual.
...
**Prefer over:** parked D-0006, seed2200 RC; re-opening D-0474…D-0537.
