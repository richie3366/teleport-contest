...
in_trouble collapsing…cursed_blindfold + minors; or remaining apply
...
**Do not re-break D-0660…D-1011. Do not FORCE CLOSE/movement/umov /
peace_minded / ualign / pet malign / shk satdoor/`onlineu` (D-0376).
**Do not re-apply D-0480 glyph `tty_map_color` in serialize (D-0483).**
**Keep:** D-0845…D-0927; D-0928 #1119–#1194; D-0929…D-0947;
**D-0948**…**D-1011** (zap/dig/eat/shop/kick/paranoid/allmain/
apply whistle·saddle·towel·crystal_ball + **in_trouble majors
Stoned…Region** — do not re-stub).
...
(D-0980); re-stub D-0983…D-1011 clusters already Keep’d above.
