...
| seed0361 | 34219/53865 | 289/366 | @34204 C nhl shuffle (Arc-goal) vs JS rn2(79) |
...
**Gameplay next:** seed0361 @34204 — C nhlib `shuffle` `rn2(3)` after
matched `getbones` vs JS `rn2(79)` (`Arc-goal` Is_special at Home 5;
post D-0618 Arc-filb). Or seed0367 `Pri-strt`, seed0014/0108. Prefer
over parked D-0006 / seed2200 RC; do not reopen D-0474…D-0618.
