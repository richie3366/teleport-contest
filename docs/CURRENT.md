...
**Next cluster:** Open — `makemon.c` `peace_minded`/`set_malign` read `ptr.msound`. Must-fix empty. Queue 8. Audit @**#1375**.
...
**Do not re-break D-0660…D-1078. Do not FORCE CLOSE/movement/umov /
peace_minded / ualign / pet malign / shk satdoor/`onlineu` (D-0376).
**Do not re-apply D-0480 glyph `tty_map_color` in serialize (D-0483).**
**Keep:** D-0845…D-0927; D-0928 #1119–#1194; D-0929…D-0947;
**D-0948**…**D-1078** (zap/dig/eat/shop/kick/allmain/apply through
...
DRAWBRIDGE_UP+`DB_LAVA` D-1077; `clone_mon` D-1078).
...
no restore `is_lava` LAVAPOOL-only (D-1077); no restore `split_mon` monster null (D-1078); no skip `mineralize` `In_endgame` before kelp; no WATER kelp
