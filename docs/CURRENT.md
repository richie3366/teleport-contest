...
**Next cluster:** `pray.c` angrygods high-anger arms (named absent.md:13, post-D-0969 residual; 0–8/default-zap shipped; never live/archived/parked). Probe: `node scripts/brief.mjs angrygods`.
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2332 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2332; wrap `wildmiss` /
