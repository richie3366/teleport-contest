...
Score last measured: **2026-07-22** — full `sessions` @**#1285** (**43**/44,
Scr **11404**/11405, RNG **100%**). Speed `31+0.27/turn` (R² 0.877).
Next cadence @**#1290**.
...
| Speed label | `31+0.27/turn` (R² 0.877) |
| Role-init throws | **0 / 44** |

**PASS (43 @#1285):** seed8000, seed0900, seed1500, seed1800, seed0060,
...
**Do not re-break D-0660…D-1014. Do not FORCE CLOSE/movement/umov /
peace_minded / ualign / pet malign / shk satdoor/`onlineu` (D-0376).
**Do not re-apply D-0480 glyph `tty_map_color` in serialize (D-0483).**
**Keep:** D-0845…D-0927; D-0928 #1119–#1194; D-0929…D-0947;
**D-0948**…**D-1014** (zap/dig/eat/shop/kick/paranoid/allmain/
...
(D-0980); re-stub D-0983…D-1014 clusters already Keep’d above.
