...
revisits the picker.
**Next cluster:** `mon.c` `monkilled` — coverage PARTIAL (C 38 L `mon.c:3377–3418` / JS 20 L in js/mhitm.js). Verify `node scripts/verify.mjs --fn monkilled` (reach regression must be 0).
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2874 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2874; wrap `wildmiss` /
