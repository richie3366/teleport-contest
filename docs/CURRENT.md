...
in the D-2636…D-2649 window (9 ACCEPTs;
...
revisits the picker.
**Next cluster:** `topten.c` writexlentry — coverage MISSING (C 51 L). Brief + verify `--fn writexlentry`.
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2649 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2649; wrap `wildmiss` /
