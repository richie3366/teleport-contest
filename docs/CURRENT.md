...
revisits the picker.
**Next cluster:** `mkmaze.c` `place_lregion` — coverage PARTIAL. Verify `node scripts/verify.mjs --fn place_lregion`.
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2830 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2830; wrap `wildmiss` /
