...
**#1345** (**44**/44, Scr **11405**/11405, RNG **100%**).
Speed `31+0.27/turn` (R² 0.87). Next cadence @**#1350**.
...
**Next cluster:** Open — tut-1 `tut_key` / eckey only. Must-fix
empty. Reviews **24** ACCEPT (`3f376b74` D-1063) and **25** ACCEPT
(`dc354c44` D-1064). Review every 3; cadence every 5 is score-only
...
**Do not re-break D-0660…D-1064. Do not FORCE CLOSE/movement/umov /
peace_minded / ualign / pet malign / shk satdoor/`onlineu` (D-0376).
**Do not re-apply D-0480 glyph `tty_map_color` in serialize (D-0483).**
**Keep:** D-0845…D-0927; D-0928 #1119–#1194; D-0929…D-0947;
**D-0948**…**D-1064** (zap/dig/eat/shop/kick/allmain/apply through
...
`l_create_object`; tut-1 `place_lregion`/`levregion_add`).
...
`setnotworn`; live `m_at` pole target; re-stub D-0983…D-1064
...
no restore tut-1 `updest`/`dndest` copy or exclude `0,0,0,0`).
