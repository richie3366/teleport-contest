...
Score last measured: **2026-07-22** — full `sessions` @**#1280** (**43**/44,
Scr **11404**/11405, RNG **100%**). Speed `30+0.26/turn` (R² 0.871).
Next cadence @**#1285**.
...
| Speed label | `30+0.26/turn` (R² 0.871) |
| Role-init throws | **0 / 44** |

**PASS (43 @#1280):** seed8000, seed0900, seed1500, seed1800, seed0060,
...
in_trouble majors (Stoned…Region + fix arms); or remaining apply
tools (blindfold-as-tool / containers).
...
**Do not re-break D-0660…D-1010. Do not FORCE CLOSE/movement/umov /
...
**D-0955**…**D-1010** (… apply whistle + **use_saddle** + **use_towel**
+ **use_crystal_ball** — do not re-stub).
...
re-stub `use_towel` / wet·dry_a_towel / burnarmor towel dry (D-1009);
re-stub `use_crystal_ball` / thin object·trap·furniture detect
(D-1010).
