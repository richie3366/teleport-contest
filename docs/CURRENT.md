...
| seed0360 | **120639**/120639 | **638**/833 | Scr residual @324 lava `` ` `` vs blank (#928) |
...
**Gameplay next:** **seed0360 screen residual** — D-0806 (#928):
`splev_mazewalk` 3-arg ftyp=ROOM (not corrmaze→CORR). Scr
**633→638**/833; prefix **318→324**. Next: @324 materialize
Dlvl:40 C DEC lava `` ` `` vs JS blank (7,9). **Do not FORCE.**
...
**Do not re-break D-0660…D-0806. Do not FORCE CLOSE/movement/umov.**
