...
**Next cluster:** absent.md thin systems under fortress
(potion/scroll/vault polish); or potion/mhitm/pray TROUBLE_LYCANTHROPE
you_were wires; or next_to_u/check_leash body.
...
**Do not re-break D-0660…D-1003. Do not FORCE CLOSE/movement/umov /
...
**D-0955**…**D-1003** (… warnreveal/overexert/eel — do not re-stub).
