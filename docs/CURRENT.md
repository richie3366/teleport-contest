...
**Next cluster:** `sit.c` `dosit` water / pool / gremlin sit (after
trap, before sink). Not the furniture list. Must-fix queue empty
after D-1054. Unattended loop pops first Open. Written reviews
...
**Do not re-break D-0660…D-1054. Do not FORCE CLOSE/movement/umov /
peace_minded / ualign / pet malign / shk satdoor/`onlineu` (D-0376).
**Do not re-apply D-0480 glyph `tty_map_color` in serialize (D-0483).**
**Keep:** D-0845…D-0927; D-0928 #1119–#1194; D-0929…D-0947;
**D-0948**…**D-1054** (zap/dig/eat/shop/kick/allmain/apply through
...
`msounds[]`/`cry_sound`; restore cobj `OBJ_CONTAINED`).
