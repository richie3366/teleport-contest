...
**Map-driven** after `goto_level` `kill_genocided_monsters` (D-1190).
First Open: `do.c` `goto_level` `run_timers` (named). Not
`kill_genocided`. Not `maybe_smudge_engr`. Fortress 44/44.

**After that:** map-driven (`debt.md` then `absent.md`). No
leaderboard chase. Parked D-0006 diagnose-only.

**Next cluster:** Open `do.c` `goto_level` `run_timers` (named).
Not `kill_genocided`. Do not revert D-1190 after losedogs.

**Parked:** D-0006. **Do not re-break D-0660…D-1190. Do not FORCE CLOSE/movement/umov /
peace_minded / ualign / pet malign / shk satdoor/`onlineu` (D-0376).
**Do not re-apply D-0480 glyph `tty_map_color` in serialize (D-0483).**
**Keep:** D-0845…D-0927; D-0928 #1119–#1194; D-0929…D-0947;
**D-0948**…**D-1190** (getdir/hurtle; `obj_delivery`; pole
...
DRAWBRIDGE_UP+`DB_LAVA` D-1077; D-1078–D-1190).
