...
Reviews **835–842** (D-1865…D-1882): 7 ACCEPT,
1 ACCEPT-WITH-DEBT, 0 Must-fix. Reviews **843–845** (D-1873…D-1882):
...
**Next cluster:** Open `invent.c` dolook — 1 corpus block screen-first at step 18 («You see here a historic statue of a forest centaur.» vs «You see here a statue of a forest centaur.»; tour-Archeologist-70010-d3-6-10-11-12).
**Open stays hidden-score ordered** (`PORT-GAP-TOP30.md`).
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-1882 (index).** Recent **D-1820:** `makemaz` `soko2-2`
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-1882; wrap `wildmiss` /
