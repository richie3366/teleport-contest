...
**Next cluster:** Open `hack.c` findtravelpath TEST_TRAV/guess/travelmap (TOP30 #29: C 257 vs JS absent; travel `_` adjacent/greedy only; never own-row live/archived/parked). Probe: `node scripts/brief.mjs findtravelpath`.
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2382 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2382; wrap `wildmiss` /
