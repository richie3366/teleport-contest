...
**Next cluster:** `u_wipe_engr` / `tmp_at` no-ops in apply: wire or
stop calling them as if they were C. Source: D-1022 risk 7. D-1050
shipped `pickup_object` telekinesis (whip TRUE silent encumbrance
refuse + remote corpse/scare `raise`; grapple FALSE ynq). Written
reviews bind: QUALITY-RISK C-wrongs are Must-fix, not optional debt.
Unattended loop pops **one** queue item per port iter (Must-fix
before Open). Review every 3; cadence every 5 is score-only
...
**Do not re-break D-0660…D-1050. Do not FORCE CLOSE/movement/umov /
peace_minded / ualign / pet malign / shk satdoor/`onlineu` (D-0376).
**Do not re-apply D-0480 glyph `tty_map_color` in serialize (D-0483).**
**Keep:** D-0845…D-0927; D-0928 #1119–#1194; D-0929…D-0947;
**D-0948**…**D-1050** (zap/dig/eat/shop/kick/paranoid/allmain/apply
...
`remove_worn_item(FALSE)`**; **`pickup_object` telekinesis**).
