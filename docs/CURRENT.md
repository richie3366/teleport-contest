...
**Map-driven fortress** after D-1388. **Next cluster:** Open
`spell.c` `spelleffects` SPE_CREATE_FAMILIAR (named). Not
force bolt. Reviews **339–345** ACCEPT-WITH-DEBT; **346**
QUALITY-RISK shipped as D-1387. Do not skip D-1388…D-1229
...
**Parked:** D-0006. **Do not re-break D-0660…D-1388.** Do not FORCE
CLOSE/movement/umov / shk satdoor/`onlineu` (D-0376).
**Do not re-apply D-0480 glyph `tty_map_color` in serialize (D-0483).**
**Keep:** D-0845…D-1388 (index). Recent: **D-1388** spell.js
SPE_FORCE_BOLT IMMEDIATE `weffects`/`bhit`. Prior: **D-1387**
unskilled FIREBALL getdir cancel leftover dirs. **D-1386**
FALLTHROUGH weffects.
**Do not / rejects:** FORCE/RNG;
HEAVY_IRON_BALL `owt!=0`;
judge-elides-RC (D-0933); extend §1.2; LB peels; skip painting
spaces; wrap `wildmiss` / `msg_mon_movement` as `pline_mon`; skip D-1229…D-1388
