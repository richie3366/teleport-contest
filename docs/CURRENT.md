...
in the D-2583…D-2595 window: Rogue-92026 fixed by D-2583 (review 1533
...
revisits the picker.
**Next cluster:** `pickup.c` lift_object — coverage PARTIAL (C 86 L `pickup.c:1705–1795` / JS 47 L in js/pickup.js; hops 3, callers 3, RNG 0, msg 3). Port the whole C body in C order. Verify `node scripts/verify.mjs --fn lift_object` (reach regression must be 0).
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2595 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2595; wrap `wildmiss` /
