...
(potion/scroll/vault polish); or warnreveal / overexert_hp /
Upolyd eel hp-loss; or potion/mhitm you_were wires.
...
**Do not re-break D-0660…D-1002. Do not FORCE CLOSE/movement/umov /
...
**D-0955**…**D-1002** (… allmain Teleport/Poly/ulycn — do not re-stub).
