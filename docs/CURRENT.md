...
Score last measured: **2026-07-21** — full `sessions` @**#1205** (**44**/44,
Scr **11405**/11405, RNG **100%**). Post D-0937 reconfirm. Speed
`32+0.27/turn` (@#1205). Next cadence @**#1210**.
...
| Speed label | `32+0.27/turn` (R² 0.85) |
| Role-init throws | **0 / 44** |

**PASS (44 @#1205):** seed8000, seed0900, seed1500, seed1800, seed0060,
...
**Hold local suite (44/44 @#1205) as a regression fortress.** Green
...
**Do not re-break D-0660…D-0941. Do not FORCE CLOSE/movement/umov /
peace_minded / ualign / pet malign / shk satdoor/`onlineu` (D-0376).
**Do not re-apply D-0480 glyph `tty_map_color` in serialize (D-0483).**
**Keep:** D-0845…D-0927; D-0928 #1119–#1194; D-0929; **D-0930**;
**D-0931**; **D-0932**; **D-0933**; **D-0934**; **D-0935**; **D-0936**;
**D-0937**; **D-0938**; **D-0939**; **D-0940**; **D-0941**
(`still_chewing` shop/`watch_dig`/`angry_guards` — do not re-stub).
