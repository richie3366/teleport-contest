...
in the D-2610…D-2621 window (8 ACCEPTs + 1 WITH-DEBT;
...
revisits the picker.
**Next cluster:** `invent.c` loot_xname whole-body port (THIN stub → C order; `mkobj.c` obj_timer_checks popped first, parked STALE — body live js/mkobj.js:2925).
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2621 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2621; wrap `wildmiss` /
