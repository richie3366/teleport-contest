...
**Gameplay next:** after D-0542 (`S_QUANTMECH`), seed0373 @22651 C
nhlib `shuffle` `rn2(3)` vs JS `rn2(79)` (`makemaz` special). Or peel
...
**Prefer over:** parked D-0006, seed2200 RC; re-opening D-0474…D-0542.
