...
**Next cluster:** `ship_object` shop-floor fall billing, or other
absent.md thin systems under fortress (kick remaining
SDOOR/furniture; potion/scroll thin; vault polish).
...
**Do not re-break D-0660…D-0983. Do not FORCE CLOSE/movement/umov /
...
**D-0955**…**D-0983** (revive/Ring_gone/grave/shopdig/bridge/
