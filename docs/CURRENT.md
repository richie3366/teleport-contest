...
in the D-2574…D-2587 window, all worktree-bisected: Rogue-92026 → D-2574
...
revisits the picker.
**Next cluster:** `uhitm.c` mhitm_ad_tlpt — coverage THIN (C 94 L `uhitm.c:2859–2955` / JS 28 L in js/mhitm.js; hops 4, callers 1, RNG 0, msg 6).
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2587 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2587; wrap `wildmiss` /
