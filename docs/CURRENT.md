...
Score last measured: **2026-08-15** — full `sessions` cadence **#1300**
(**44**/44, Scr **11405**/11405, RNG **100%**). Speed `31+0.27/turn`
(R² 0.867). Next cadence @**#1305**.
...
| Speed label | `31+0.27/turn` (R² 0.867) |
...
**Next cluster:** sit.c ordinary `throne_sit_effect` cases 1–13
(adjattrib/wish/genocide/courtmon/mapping/tele/identify). Remaining
nhl_gamestate memcpy u/disco/mvitals/spl_book + `init_uhunger` named
in `startup.md`. `hatch_egg` still deferred in timeout.
...
**Do not re-break D-0660…D-1033. Do not FORCE CLOSE/movement/umov /
peace_minded / ualign / pet malign / shk satdoor/`onlineu` (D-0376).
**Do not re-apply D-0480 glyph `tty_map_color` in serialize (D-0483).**
**Keep:** D-0845…D-0927; D-0928 #1119–#1194; D-0929…D-0947;
**D-0948**…**D-1033** (zap/dig/eat/shop/kick/paranoid/allmain/
...
**`use_grease`/`use_tinning_kit`/`use_bell`/`use_figurine`** +
**`use_unicorn_horn`/`hornoplenty`/`fig_transform`** +
**`special_throne_effect` grease spray / Vlad sit**
— do not re-stub).
...
D-0983…D-1033 clusters already Keep’d above.
