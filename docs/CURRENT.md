...
**Gameplay next:** after D-0528 (`tower1` load_special + vampshift),
seed0373 next @4571 C Bar-loca `load_special` nhlib `shuffle` vs JS
...
**Prefer over:** parked D-0006, seed2200 RC; re-opening D-0474…D-0528.
