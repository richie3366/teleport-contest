...
| seed0014 | 14628/59178 | 298/714 | prefix @14566 `zhitm` `d(6,6)` vs `rn2(10)` |
...
**Gameplay next:** seed0014 after D-0681 cursed_book — first mismatch
@14566 C `zhitm` `d(6,6)` vs JS `rn2(10)` (`dobuzz`/`zhitm`). Or
