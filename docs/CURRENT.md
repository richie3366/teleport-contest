...
revisits the picker.
**Next cluster:** `do_wear.c` find_ac — coverage PARTIAL (C 52 L `do_wear.c:2473–2525` / JS 37 L in js/u_init.js). Port the whole C body in C order. Verify `node scripts/verify.mjs --fn find_ac`.
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2797 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2797; wrap `wildmiss` /
