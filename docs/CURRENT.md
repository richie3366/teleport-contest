...
**Gameplay next:** **seed0360 @31374** after D-0747 valley —
C `mkclass_aligned` `rn2(2)` vs JS still in `rn2(9)` (morgue/fill?).
Prefer over D-0731/D-0708 mfndpos (omit-cell C-state still missing).
Do **not** re-break D-0660…D-0747.

```bash
node frozen/ps_test_runner.mjs \
  sessions/seed0360-wizard-world-tour.session.json
# @31374 C mkclass_aligned rn2(2) vs JS rn2(9)
