...
revisits the picker.
**Next cluster:** `light.c` `arti_light_radius` — coverage THIN (first Open — coverage row after D-2868). Verify `node scripts/verify.mjs --fn arti_light_radius` (reach regression must be 0).
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2868 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2868; wrap `wildmiss` /
