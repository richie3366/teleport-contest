...
**Next cluster:** `apply.c` use_unicorn_horn trouble-fix envelope (debt.md D-1030; C apply.c use_unicorn_horn). Probe: `node scripts/brief.mjs use_unicorn_horn`. → **PARKED 2026-09-15** (D-1030 family; proof in Parked). use_towel → **PARKED 2026-09-15** (D-1009; proof in Parked). use_tinning_kit → **PARKED 2026-09-15** (D-1027 stale duplicate; proof in Parked). Next pop: `eat.c` costly_tin row.
