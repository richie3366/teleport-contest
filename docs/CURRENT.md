...
| seed0373 | 12023/35386 | 22/124 | D-0535; next `collect_coords` @11988 |
...
**Gameplay next:** after D-0535 (`rnd_offensive_item` case-0 FALLTHROUGH),
seed0373 @11988 C `collect_coords` `rn2(8)` vs JS `rn2(2)`. Or peel
...
**Prefer over:** parked D-0006, seed2200 RC; re-opening D-0474…D-0535.
