...
in the D-2512…D-2522 window (Valkyrie-92200, Samurai-92018), 0 regressed
...
revisits the picker.
**Next cluster:** `do.c` canletgo — coverage PARTIAL (C 46 L `do.c:665–711` / JS 33 L in js/do.js; hops 2, callers 13, RNG 0, msg 4). Port the whole C body in C order — every arm, every callee live or named in the map, every C caller wired. Verify `node scripts/verify.mjs --fn canletgo` (reach regression must be 0). Measured `port-coverage.mjs --name canletgo` 2026-09-19 @ 7b5fbce5.
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2522 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2522; wrap `wildmiss` /
