...
Scr **9898**/11405, RNG **90.45%**). Next cadence @**#1060**. #1057
D-0907 study learn: seed4500 Scr **459→481** prefix **49776→49915**.
...
| seed4500 | 50071/108275 | 481/1814 | knight coverage; next @49915 mkobj |
...
`rn2(19)` after matched study learn/makeknown). Focused:
...
**Do not re-break D-0660…D-0907. Do not FORCE CLOSE/movement/umov.**
...
D-0861…D-0907 (searches_for_item … study learn/makeknown).
