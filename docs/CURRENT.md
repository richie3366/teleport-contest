...
Score last measured: **2026-08-15** — full `sessions` after D-1037
(**44**/44, Scr **11405**/11405, RNG **100%**). Speed `33+0.28/turn`
(R² 0.869). Next cadence @**#1310**.
...
| Speed label | `33+0.28/turn` (R² 0.869) |
...
**Do not re-break D-0660…D-1037. Do not FORCE CLOSE/movement/umov /
peace_minded / ualign / pet malign / shk satdoor/`onlineu` (D-0376).
**Do not re-apply D-0480 glyph `tty_map_color` in serialize (D-0483).**
**Keep:** D-0845…D-0927; D-0928 #1119–#1194; D-0929…D-0947;
**D-0948**…**D-1037** (zap/dig/eat/shop/kick/paranoid/allmain/
...
D-0983…D-1037 clusters already Keep’d above.
**Do not peel RANGE_LEVEL timers from invent/migrating objects**
