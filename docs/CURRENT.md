...
**Next cluster:** Open `vault.c` wallify_vault body (turns.md:3746; move_gold D-1946 caller omitted; local clone in js/; never own-row live/archived/parked). Probe: `node scripts/brief.mjs wallify_vault`.
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2390 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2390; wrap `wildmiss` /
