...
**Next cluster:** Must-fix `uhitm.c` hmon_hitmon_weapon_ranged boomerang tail `:901–917` (review 1006 C-wrong 1; then the silver-predicate swap and dokick caitiff await).
