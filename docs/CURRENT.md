...
**Next cluster:** `potion.c` peffect_water body (debt.md:23 potionbreathe POT_WATER lycan residual; never own-row live/archived/parked). Probe: `node scripts/brief.mjs peffect_water`.
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2377 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2377; wrap `wildmiss` /
