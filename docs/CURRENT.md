...
**Map-driven fortress** after D-1310. Reviews **265–268** all
**ACCEPT-WITH-DEBT** (no Must-fix).
**Next cluster:**
Open `dothrow.c` throwit tethered DISP_TETHER / BACKTRACK
(named from D-1303). Not leader catch.
Do not skip D-1310…D-1229 (index). Keep mention_map addr. Do not wrap
`wildmiss` or `msg_mon_movement` as `pline_mon`.
Do not pull explmu / AT_HUGS / mhitu AD_DRIN / candelabrum n-of-7 /
thitmonst leader catch.

**Parked:** D-0006. **Do not re-break D-0660…D-1310.** Do not FORCE
CLOSE/movement/umov / shk satdoor/`onlineu` (D-0376).
**Do not re-apply D-0480 glyph `tty_map_color` in serialize (D-0483).**
**Keep:** D-0845…D-1310 (index). Recent: **D-1310** `dokick.c`
`kick_monster` poly AT_KICK. Prior: D-1309 `mhitu.c` `mattacku`
...
spaces; wrap `wildmiss` / `msg_mon_movement` as `pline_mon`; skip D-1229…D-1310
