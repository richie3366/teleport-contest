...
in the D-2688…D-2705 window (6 ACCEPT, 2 WITH-DEBT, 1 QUALITY-RISK;
...
revisits the picker.
**Next cluster:** `dungeon.c` query_annotation — coverage PARTIAL (C 67 L `dungeon.c:2500–2567` / JS 41 L in js/dungeon.js; hops 5, callers 2, RNG 0, msg 0). Port the whole C body in C order — every arm, every callee live or named in the map, every C caller wired. Verify `node scripts/verify.mjs --fn query_annotation` (reach regression must be 0). Measured `port-coverage.mjs --name query_annotation` 2026-09-21 @ 2dfc3677.
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2705 (index).**
<!-- recent:begin -->
**D-2705**  — 
**D-2704**  — 
**D-2703**  — 
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2705; wrap `wildmiss` /
