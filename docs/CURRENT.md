...
**Next cluster:** `sp_lev.c` flip_level lregion coord update (named data.md:773; never live/archived/parked). Probe: `node scripts/brief.mjs flip_level`.
**DUMPLOG retired (D-1776)** — do not re-enqueue.
**Keep D-0845…D-2336 (index).**
<!-- recent:begin -->
...
(D-1831 `_snapshotStatusGrid`); skip D-1229…D-2336; wrap `wildmiss` /
