...
D-0359 **24/44**; seed0009 PASS). Not refreshed this iter (#383).
...
|---------|----:|-------:|------|
| seed0012 | **3255**/13878 | **14**/308 | D-0362 #loot; next @3204 `xkilled` |
...
**seed0012 @3204** — after D-0362 `#loot`: C `xkilled` `rn2(6)` vs JS
`rn2(25)` (kill message / corpse path).
