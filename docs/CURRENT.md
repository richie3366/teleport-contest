...
**Next cluster:** Open — `sit.c` `split_mon` monster `clone_mon` arm (JS named omit). Must-fix empty. Queue 9. Cadence @**#1370**.
...
**Do not re-break D-0660…D-1077. Do not FORCE CLOSE/movement/umov /
peace_minded / ualign / pet malign / shk satdoor/`onlineu` (D-0376).
**Do not re-apply D-0480 glyph `tty_map_color` in serialize (D-0483).**
**Keep:** D-0845…D-0927; D-0928 #1119–#1194; D-0929…D-0947;
**D-0948**…**D-1077** (zap/dig/eat/shop/kick/allmain/apply through
...
no restore `is_lava` LAVAPOOL-only (D-1077); no skip `mineralize` `In_endgame` before kelp; no WATER kelp
