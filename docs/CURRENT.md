...
`fill_ordinary_room` `rn2(5)` vs JS `rn2(3)` — reconstruct C path). Focused:
...
**Do not re-break D-0660…D-0902. Do not FORCE CLOSE/movement/umov.**
...
D-0861…D-0902 (searches_for_item … shkveg).
