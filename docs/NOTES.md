...
- **Fortress 44/44** after D-1498; cadence **#1880** `8669b5b8`
  (Scr **11,405** RNG 100%, `39+0.30/turn`). Next: Open
  `potion.c` `potion_dip` `poly_obj`/`obj_unpolyable`.
  Not mixtype.
  Do not skip D-1498…D-1229. No FORCE / `wildmiss` wrap /
...
- Do not revert D-1217–D-1498. Named still: `any_visible_region`;
...
- Do not restore rhack raw-ETX (D-1189). Do not skip D-1190…D-1498.
...
- Do not restore tut-1 hardcoded keys (D-1065) / skip `tutorial()`
  nhcore (D-1066). Do not skip D-1067…D-1498 (index).
- Named still: worm-shrieker; potion_dip `poly_obj`;
...
- D-1498: `potion_dip` POT_OIL lit `fire_damage` / cursed
  ...
  not darts. Brass lantern skip. `poly_obj` named.
...
- D-1486: `potion_dip` unicorn/amethyst mixtype.
  Poison-coat is D-1497; oil/lamp is D-1498; `poly_obj` /
  `dip_into` named.
