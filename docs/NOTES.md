...
- **seed0014 Scr 620/714** — RNG **FULL** after D-0877 bath/somegold.
  Next: first screen miss (cells/cursor). Falsifier: focused seed0014.
- Leaderboard 22-vs-38 gap — await cron; D-0483 serialize revert.

## Don't re-check (≤15)

- No raw RNG-index / coordinate / FORCE in production; Rule #2 no `fs`.
- Don't re-apply D-0480 space coerce (D-0483); D-0471…D-0877 done.
...
- Quest seed0367 **PASS**; seed0014 next screens @620.
