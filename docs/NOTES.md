...
- Suite **#1470** **44**/44; next @**#1475**. Open 11.
- **Next:** `mon.c` `m_poisongas_ok` mfndpos vamp/eel/breath (named).
- **Hypothesis:** C OK for vamp/eel-pool/AT_BREA poison; JS mfndpos helper
  is nonliving/breathless (`mon.c:330–357` vs `js/mon.js`).
...
- Do not skip D-1071…D-1093 (hugs through MS_LEADER) /
  ...
  `classify_terrain` (D-1151) / skip `rloc_to` `maybe_unhide_at` (D-1152) / vault_tele false (D-1153) / skip `pick_vibrasquare` / hellfill VS (D-1154) / skip `expire_gas_cloud` dissipation (D-1155) / skip fumaroles whoosh (D-1156) / D-1158).
...
- Suite **#1470** **44**/44. Next @**#1475**. **D-1158**.
