...
- **Suite 44/44** after D-1692 (cadence **#2100** at `ac1199da`).
  ...
  **Falsify:** `node scripts/csym.mjs print_mapseen` — knox/drawbridge
  arms vs JS `js/dungeon.js`.
  **Next:** Open `dungeon.c` print_mapseen knox/drawbridge. Not cemetery
  JSON.
  Do not skip D-1531…D-1692. Do not re-port D-1675…D-1692.
...
- Do not restore rhack raw-ETX (D-1189). Do not skip D-1190…D-1692.
...
- Do not restore tut-1 hardcoded keys (D-1065) / skip `tutorial()`
  nhcore (D-1066). Do not skip D-1067…D-1692 (index).
- Do not import `monmove.js` `sticks` for sit. Do not rewrite
  `confer_oc_oprop`. Do not re-port `eyecount`. Do not skip
  D-1520…D-1692. Do not delete emin (**487**). Do not stub
...
- Do not import `wield.js`/`pickup.js`→`polyself.js` for `body_part`
  ...
  `vision_reset`. D-1576…D-1692 in the index. No yn ^P glue /
