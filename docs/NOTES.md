...
- Latest: **D-0944** `mconveys` + `corpse_intrinsic`/`givit`.
  Falsifier: green + eat/role cohort PASS.
- Next cluster: eatspecial PAPER/potion/ring; were* `set_ulycn`;
  mimic gold `eatmdone`; `attrcurse`; dokick/explode/apply dig
  `pay_for_damage` sites; pickaxe `is_digging`; other `debt.md` row.
...
- Do not re-stub TIN / multi-turn rations (D-0935), non-food eat
  ...
  (D-0943), or `corpse_intrinsic`/`givit`/`mconveys` (D-0944).
