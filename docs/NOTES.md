...
- **Suite 44/44** fortress (cadence **#2140** at `4bc17535`, R² 0.863).
  ...
  display_monster Protection_from_shape_changers sensed. Not
  Detect_monsters cansee. Falsify: sensed arm in `display_monster`
  (not M_AP_FURNITURE lastseentyp). Do not skip D-1531…D-1735.
  Do not re-port D-1675…D-1735.
...
- Do not restore rhack raw-ETX (D-1189). Do not skip D-1190…D-1735.
...
- Do not restore tut-1 hardcoded keys (D-1065) / skip `tutorial()`
  nhcore (D-1066). Do not skip D-1067…D-1735 (index).
- Do not import `monmove.js` `sticks` for sit. Do not rewrite
  `confer_oc_oprop`. Do not re-port `eyecount`. Do not skip
  D-1520…D-1735. Do not delete emin (**487**). Do not stub
...
- Do not import `wield.js`/`pickup.js`→`polyself.js` for `body_part`
  ...
  catchup reads it. Do not re-port D-1682…D-1735. D-1735 is write.c
