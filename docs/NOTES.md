...
- **Suite 44/44** after D-1643 (cadence **#2040** at `f9bed6be`).
  seed4500 still PASS. **Hypothesis:** C `do.c` `record_achievement`
  `ACH_ASTR` (named). Not `reset_hostility` (D-1616).
  **Falsify:** `node scripts/map.mjs do.c` + `csym.mjs record_achievement`
  / ACH_ASTR.
  **Next:** Open ACH_ASTR. Do not skip D-1531…D-1643.
  Do not glue ACH_ASTR onto reset_hostility. Do not re-port D-1621…D-1643.
- Named still: sit/pray `eyecount`; Palantir `#if 0`; pit/underwater;
  clone auto-open yn; `rescham` wiz_intrinsic;
  `optfn_perminv_mode` / `handler_perminv_mode`; ACH_ASTR; setworn
...
- Do not restore rhack raw-ETX (D-1189). Do not skip D-1190…D-1643.
...
- Do not restore tut-1 hardcoded keys (D-1065) / skip `tutorial()`
  nhcore (D-1066). Do not skip D-1067…D-1643 (index).
- Do not import `monmove.js` `sticks` for sit. Do not rewrite
  `confer_oc_oprop`. Do not skip D-1520…D-1643. Do not delete emin
...
- Do not import `wield.js`/`pickup.js`→`polyself.js` for `body_part`
  ...
  `vision_reset`. D-1576…D-1643 live in the index. Do not glue yn ^P
  ...
  D-1605…D-1643 (`doperminv` / tty WIN_INVEN `assesstty` is D-1642;
  `check_invent_gold` is D-1641; landing_spot KNOCKED is D-1640;
  ESC-nonempty D-1639; do_mgivenname D-1638; BIND= M('?') is D-1643). Do not dump
