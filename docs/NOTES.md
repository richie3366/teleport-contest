...
- **#1508** 44/44 @**#1510**. D-1187 yn shipped (107→108). Next
  @108 `teleport.c` `domagicportal` activate / ATSTAIRS stunmsg.
...
- Do not skip D-1071…D-1093 (hugs through MS_LEADER) /
  ...
  `classify_terrain` (D-1151); D-1152…D-1187 in CURRENT Keep).
...
- **#1508** **44**/44 @**#1510**. **D-1187**. Review **142–146** ACCEPT.
