...
- **#1510** 44/44 @**#1515**. Next wizkit `obj_delivery(FALSE)`.
...
- Do not restore rhack raw-ETX (D-1189 `visctrl`). Do not skip
  `goto_level` `kill_genocided` (D-1190) or `run_timers` (D-1191).
...
- Do not skip D-1071…D-1093 (hugs through MS_LEADER) /
  ...
  `classify_terrain` (D-1151); D-1152…D-1191 in CURRENT Keep).
...
- **#1510** **44**/44 @**#1515**. Next wizkit `obj_delivery`.
