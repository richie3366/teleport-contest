...
- **#1480** 44/44 @**#1485**. Next: do.c `goto_level` in_out_region.
...
- Do not skip D-1071…D-1093 (hugs through MS_LEADER) /
  ...
  `classify_terrain` (D-1151) / skip `rloc_to` `maybe_unhide_at` (D-1152) / skip `rloc_to` `set_apparxy` or restore mux=hero (D-1160) / skip `rloc_to` `update_monster_region` (D-1161) / skip rloc_to angry/bill/mintrap (D-1162–D-1164) / vault_tele false (D-1153) / skip `pick_vibrasquare` / hellfill VS (D-1154) / skip `expire_gas_cloud` dissipation (D-1155) / skip fumaroles whoosh (D-1156) / thinner mfndpos gas (D-1159)).
...
- Suite **#1480** **44**/44. Next @**#1485**. **D-1165**.
