...
- **Suite 44/44** fortress. Save-oracle required for tagged restore
  ...
  shop template 35/35 (no unpaid). **Next:** Open `getline.c`
  yn_function addcmdq. Do not skip D-1531…D-1705. Do not re-port D-1675…D-1705.
- Named still: Palantir `#if 0`; pit/underwater; clone auto-open yn;
  ...
  `observe_object` FIRST_OBJECT skip; yn addcmdq; Hallu
  `obj_to_glyph` query; invent.c `useupall` / `obfree`.
...
- Do not restore rhack raw-ETX (D-1189). Do not skip D-1190…D-1705.
...
- Do not restore tut-1 hardcoded keys (D-1065) / skip `tutorial()`
  nhcore (D-1066). Do not skip D-1067…D-1705 (index).
- Do not import `monmove.js` `sticks` for sit. Do not rewrite
  `confer_oc_oprop`. Do not re-port `eyecount`. Do not skip
  D-1520…D-1705. Do not delete emin (**487**). Do not stub
...
- Do not import `wield.js`/`pickup.js`→`polyself.js` for `body_part`
  ...
  `vision_reset`. D-1576…D-1705 in the index. No yn ^P glue /
  ...
  D-1682…D-1705 (index). D-1705 `bill_box_content` nested unpaid
