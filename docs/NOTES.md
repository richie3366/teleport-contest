...
- **Suite 44/44** fortress. Save-oracle required for tagged restore
  ...
  recalc_mapseen Blind bigroom / oracle / valley / sanctum. Do not
  skip D-1531…D-1706. Do not re-port D-1675…D-1706.
- Named still: Palantir `#if 0`; pit/underwater; clone auto-open yn;
  ...
  yyyymmddhhmmss when[]; Blind bigroom/oracle/valley/sanctum;
  DRAWBRIDGE_UP/mimic lastseentyp; guardian remaps; Punished
  float_down; water/lava steed; uhitm `u.dx`; map_menu_cmd;
  `context.novel`; walk-key / PREFIXCMD overlay; `possibly_unwield`
  / `mon_break_armor`; sync `newcham`; array rn2 / pauper_legacy /
  killed_nemesis; spell dull / zap rider eyecount; perm_invent
  can_set; polyself `uskin=`; steal/muse `unknow_object`; `oc_merge`;
  `observe_object` FIRST_OBJECT skip; Hallu `obj_to_glyph` query;
  invent.c `useupall` / `obfree`; `yn_function_menu` (`query_menu`);
  getdir yn_function.
...
- Do not restore rhack raw-ETX (D-1189). Do not skip D-1190…D-1706.
...
- Do not restore tut-1 hardcoded keys (D-1065) / skip `tutorial()`
  nhcore (D-1066). Do not skip D-1067…D-1706 (index).
- Do not import `monmove.js` `sticks` for sit. Do not rewrite
  `confer_oc_oprop`. Do not re-port `eyecount`. Do not skip
  D-1520…D-1706. Do not delete emin (**487**). Do not stub
...
- Do not import `wield.js`/`pickup.js`→`polyself.js` for `body_part`
  ...
  `vision_reset`. D-1576…D-1706 in the index. No yn ^P glue /
  ...
  D-1682…D-1706 (index). D-1706 yn addcmdq (getobj/paranoid/askchain
  stay FALSE). D-1705 `bill_box_content` nested unpaid
  (dummy→billobjs named). D-1704 dopay getpos. D-1703
  `shk_names_obj`. D-1702 buy_container (no FullyUsedUp).
