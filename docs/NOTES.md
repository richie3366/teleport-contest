...
- **Fortress 44/44** after D-1418; cadence **#1780** `285218b2`
  (Scr **11,405** RNG 100% speed `38+0.31/turn` R² 0.85). Next:
  Open `spell.c` `spelleffects` SPE_LEVITATION peffects
  (named from D-1408). Not RESTORE_ABILITY. Reviews
  **365–373** ACCEPT-WITH-DEBT (no Must-fix). Do not skip
  D-1418…D-1229. No FORCE. Do not wrap `wildmiss`. Do not add
  trailing `confdir` to shared `getdir`.
- Do not revert D-1217–D-1418. Named still: `see_monsters`
...
- Do not restore rhack raw-ETX (D-1189). Do not skip D-1190…D-1418.
...
- Do not restore tut-1 hardcoded keys (D-1065) / skip `tutorial()`
  nhcore (D-1066). Do not skip D-1067…D-1418 (index).
- Named still: rustm / poison / worm-shrieker;
  remaining peffects (LEVITATION /
  ...
  DETECT_TREASURE D-1417; DETECT_MONSTERS D-1418. No fountain
...
- D-1418: `spell.c` SPE_DETECT_MONSTERS peffects `:1534–1546`
  ...
  LEVITATION / cursed wake / blessed WIN_MAP still named.
