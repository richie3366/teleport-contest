...
- **Fortress 44/44** after D-1346; cadence **#1705** `2a5e72e0`
  (Scr **11,405** RNG 100% speed `37+0.29/turn`). Reviews **304–307**
  ACCEPT-WITH-DEBT (no Must-fix). Next: Open `objnam.c` warn_obj
  glow (named from D-1322). Not killer_xname. Do not skip
  D-1346…D-1229. Do not wrap `wildmiss` as `pline_mon`. No FORCE.
- Do not revert D-1217–D-1346. warn_obj / `artifact_light` `)`
...
- Do not restore rhack raw-ETX (D-1189). Do not skip D-1190…D-1346.
...
- Do not skip D-1071…D-1346 (index). Named still: hitmm silver
...
- D-1335: `objnam.c` `killer_xname` `:1942–2005` — dokick `:498` +
  petrify `:551–554`. eat choke D-1344; dozap D-1345; throwit D-1346.
