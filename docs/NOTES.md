...
- **Suite 44/44** fortress (cadence **#2140** at `4bc17535`, R² 0.863).
  ...
  newsym Detect_monsters cansee. Not furniture lastseentyp. Falsify:
  cansee `see_it || (!worm_tail && Detect_monsters)` then DETECTED.
  Do not skip D-1531…D-1736. Do not re-port D-1675…D-1736.
- Named still: Palantir `#if 0`; pit/underwater; clone auto-open yn;
  `rescham`; setworn oc_oprop; keepdogs leash; `initedog`; tip-spill;
  hideunder; Detect_monsters cansee; mimic `map_object`; Punished
...
- Do not restore rhack raw-ETX (D-1189). Do not skip D-1190…D-1736.
...
- Do not restore tut-1 hardcoded keys (D-1065) / skip `tutorial()`
  nhcore (D-1066). Do not skip D-1067…D-1736 (index).
- Do not import `monmove.js` `sticks` for sit. Do not rewrite
  `confer_oc_oprop`. Do not re-port `eyecount`. Do not skip
  D-1520…D-1736. Do not delete emin (**487**). Do not stub
...
- Do not import `wield.js`/`pickup.js`→`polyself.js` for `body_part`
  ...
  catchup reads it. Do not re-port D-1682…D-1736. D-1736 is
...
- D-1736: `display_monster` `:518–519` Protection || sensemon. Live
  `display.js`. Named: Detect_monsters cansee; map_object observe.
...
- D-1726: furniture lastseentyp. Named: Detect_monsters cansee.
