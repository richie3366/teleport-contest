...
- **Suite 44/44** fortress (cadence **#2150** at `3c4dafe8`, R² 0.856).
  ...
  see_monsters MON_STILL_ARRIVING skip. Not newsym Detect_monsters.
  Falsify: C `see_monsters` `MON_STILL_ARRIVING` continue vs newsym
  !cansee DETECTED (D-1745). Do not skip D-1531…D-1745. Do not
  re-port D-1675…D-1745.
- Named still: Palantir `#if 0`; pit/underwater; clone auto-open yn;
  ...
  `doseduce`/`ld()`; `see_monsters` MON_STILL_ARRIVING; pet/detected
  glyphs; `show_mon_or_warn` I-glyph.
...
- Do not restore rhack raw-ETX (D-1189). Do not skip D-1190…D-1745.
...
- Do not restore tut-1 hardcoded keys (D-1065) / skip `tutorial()`
  nhcore (D-1066). Do not skip D-1067…D-1745 (index).
- Do not import `monmove.js` `sticks` for sit. Do not rewrite
  `confer_oc_oprop`. Do not re-port `eyecount`.   Do not skip
  D-1520…D-1745. Do not delete emin (**487**). Do not stub
...
- Do not import `wield.js`/`pickup.js`→`polyself.js` for `body_part`
  ...
  catchup reads it.   Do not re-port D-1682…D-1745. D-1745 is
...
- D-1745: `newsym` `:1046–1054` !cansee
  ...
  Named: pet/detected glyphs; `show_mon_or_warn`; MON_STILL_ARRIVING.
