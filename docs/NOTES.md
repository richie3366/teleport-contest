...
- **#921 D-0800:** Wiz-loca + Wiz-fila/filb loaders. seed0360 RNG
  **FULL 120639**; Scr **519→561**/833.
- **Hypothesis next:** screen residual after RNG match — display /
  map memory / cursor / `--More--` path, not missing special-level RNG.
- **Falsify:** first mismatched screen frame vs C (cells/cursor); check
  whether residual is post-Wiz-goal visit or earlier tour display.
- **Don’t:** FORCE CLOSE/mov/umov; leave DIAG; re-clear CLOSE ≤112000;
  invent screen-alignment queues.

## Don’t re-check (≤15)

- No raw RNG-index / coordinate / ux0 / forced-gettrack in production.
- Rule #2: no `fs`/`path`/`url` in scored `js/` (D-0477).
- Don’t re-apply D-0480 space coerce (D-0483); D-0471…D-0800 done.
...
- seed0006/0007/0398/0373/**seed5006**/ **seed0116** / **seed0361** /
  **seed0367** / **seed0108** / **seed5002** **PASS** (suite **37/44**
  @#920 Scr **8525** RNG **644653**/81.31%; seed0360 RNG **FULL** Scr
  **561** @#921).
