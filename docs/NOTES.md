...
- **seed0014 Scr 633/714** — RNG FULL; D-0881 fixed @388/@393 short_oname.
  Next: @415 take-off shield — topline matches but botl **AC:10** (C) vs
  **AC:14** (JS). Then @416–417 nymph steal “from right hand” / vanish
  wording. Falsifier: focused seed0014.
...
- Quest seed0367 **PASS**; seed0014 next @415 take-off AC botl.
