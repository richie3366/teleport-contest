...
- **Fortress 44/44** after D-1459; cadence **#1840** `01edf8b9`
  (Scr **11,405** RNG 100%). Next: Open `zap.c` `weffects`
  SPE_CANCELLATION IMMEDIATE wand-duplicate (named). Not
  STONE.
  Do not skip D-1459…D-1229. No FORCE / `wildmiss` wrap /
  trailing `confdir` in shared `getdir`.
- Do not revert D-1217–D-1459. Named still: `see_monsters`
...
- Do not restore rhack raw-ETX (D-1189). Do not skip D-1190…D-1459.
...
- Do not restore tut-1 hardcoded keys (D-1065) / skip `tutorial()`
  nhcore (D-1066). Do not skip D-1067…D-1459 (index).
- Named still: worm-shrieker; unicorn/amethyst mix / potionhit /
  potionbreathe; wand-duplicate IMMEDIATE CANCEL/STONE/TELE;
