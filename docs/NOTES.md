...
- Local suite **44**/44 after cadence **#1455**; next @**#1460**.
  Map-driven. Must-fix empty. Open 12.
- **Next:** `do_name.c` `rndcolor` (named from hcolor).
...
- Suite **#1455** **44**/44. Next @**#1460**. **D-1145:** `623bc861`. **D-1146:** hash next.
