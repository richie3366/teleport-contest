...
- **#779 D-0700 fixed:** `ohitmon` range==-1 re-extract — rolling boulder
  from trap (60,10) launch 64→56 now rests at **56,10** (was stuck on trap).
  That was why C travel stopped + `n` dopush while JS walked empty 56,10.
- **New miss seed0014 @35246:** C `mdig_tunnel` `rnd(12)` vs JS `rn2(8)`.
  Correct boulder rest exposed this; old 36031 prefix was lucky with wrong
  boulder cell. Falsifier:
  `node scripts/rng-diff.mjs sessions/seed0014-dequa-fountain-explore.session.json`
- **Don’t:** revert D-0700 re-extract; force travel stop; frame-align;
  re-break D-0660…D-0699.

## Don’t re-check (≤15)

- No raw RNG-index / coordinate / ux0 / forced-gettrack in production.
- Rule #2: no `fs`/`path`/`url` in scored `js/` (D-0477).
- Don’t re-apply D-0480 space coerce (D-0483); D-0471…D-0700 done.
...
- D-0676…D-0700: blue DSM / … / ohitmon rolling re-extract.
...
- Quest: seed0367 **PASS**. seed0014 @35246 after D-0700 boulder rest.
...
- Rolling boulder: `launch_obj` + `ohitmon` range==-1 re-extract (D-0700).
