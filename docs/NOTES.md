...
- Do not restore rhack raw-ETX (D-1189). Do not skip D-1190…D-1773.
...
- Do not restore tut-1 hardcoded keys (D-1065) / skip `tutorial()`
  nhcore (D-1066). Do not skip D-1067…D-1773 (index).
...
- Do not import `wield.js`/`pickup.js`→`polyself.js` for `body_part`
  ...
  D-1682…D-1773. D-1773 is `gold_detect` (not findone / food_detect /
  object_detect `clear_stale_map` caller / sense_trap D-1753).
  D-1772 Halt. D-1771 `useupf`. D-1770 zap `delete_contents`.
  D-1769 `set_bc`. D-1768 Unaware talk. D-1767 gbuf stamp. No
