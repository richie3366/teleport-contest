...
- **Suite 44/44** after D-1695 (cadence **#2100** at `ac1199da`).
  seed4500 still PASS. **Hypothesis:** JSON `dosave0` still omits other
  `LFILE_EXISTS` floors. **Falsify:** private ledger recipe after
  Cluster 3. **Next:** Cluster 2 `serLevel` codec. Not mO perminv.
  Do not skip D-1531…D-1695. Do not re-port D-1675…D-1695.
...
- Do not restore rhack raw-ETX (D-1189). Do not skip D-1190…D-1695.
...
- Do not restore tut-1 hardcoded keys (D-1065) / skip `tutorial()`
  nhcore (D-1066). Do not skip D-1067…D-1695 (index).
- Do not import `monmove.js` `sticks` for sit. Do not rewrite
  `confer_oc_oprop`. Do not re-port `eyecount`. Do not skip
  D-1520…D-1695. Do not delete emin (**487**). Do not stub
...
- Do not import `wield.js`/`pickup.js`→`polyself.js` for `body_part`
  ...
  `vision_reset`. D-1576…D-1695 in the index. No yn ^P glue /
...
- D-1695: `goto_level` stash RANGE_LEVEL lights + `billobjs`;
  ...
  cant_go_back FREEING. `serLevel` is Cluster 2. D-1694 traps.
