...
- **seed0014 Scr 621/714** — RNG FULL; D-0878 fixed screen@47 shatter.
  Next: screen@212 C `You learn more about your items by comparing
  them.--More--` vs JS invent `d - an uncursed food ration…`.
...
- Don't re-apply D-0480 space coerce (D-0483); D-0471…D-0878 done.
...
- Quest seed0367 **PASS**; seed0014 next @212 compare-items.
