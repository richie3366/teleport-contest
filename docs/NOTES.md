...
- **Gameplay next (D-0928):** seed4500 @**100395**. #1100 landed
  `check_caitiff` → abuse=2 → Erinys HD; prefix **95154→100395**.
  Next: `gush` `rn2(3)` vs JS `rn2(20)` (fountain.c). Focused:
