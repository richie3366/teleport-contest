...
- Latest: **D-0997** animate_statue/activate_statue_trap + Blind kick
  feel + break_statue/dosearch wire.
- **Next cluster:** absent.md thin (potion/scroll/vault); or dopay
  appease; or apply camera/ParanoidBreakwand.
...
- Do not re-stub TIN … furniture/HOLE (D-0954) … through animate_statue/
  Blind kick feel (D-0997) or drop `objects_at` from timeout mkobj
  (D-0980).
