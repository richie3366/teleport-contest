...
- **#918 D-0798:** `goto_level` quest-Home `ok_to_quest` gate. seed0360
  prefix **112279→112857**; Scr **504→519**; RNG **112956**.
- **Falsified:** umovement surplus / FORCE −12 as root — C blocked
  Wiz-goal ^V with mysterious-force pline; JS did getbones early.
- **Hypothesis next:** @112857 C `distfleeck` vs JS `set_apparxy`
  (mux already at hero on C). Shared mkmaze prefix matched through
  112856. Don’t FORCE CLOSE/umov.
- **Falsify:** compare mux/muy + set_apparxy arms at first desync mon;
  C vs JS after place_lregion stream.
...
- Don’t re-apply D-0480 space coerce (D-0483); D-0471…D-0798 done.
...
- seed0006/0007/0398/0373/**seed5006**/ **seed0116** / **seed0361** /
  **seed0367** / **seed0108** / **seed5002** **PASS** (suite **37/44**
  @#915 Scr **8397** RNG **643814**/81.20%; seed0360 **112956**/519).
...
- **wizard2** (D-0771); **Wiz-strt** FlipY (D-0776/D-0782);
  ...
  **quest Home ok_to_quest** (D-0798). `special_obj_hits_leader` deferred;
