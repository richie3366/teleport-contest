...
- Suite **#1465** **44**/44; next @**#1470**. Map-driven. Open 10.
- **Next:** `region.c` `expire_gas_cloud` dissipation plines (named). Not inside_gas HP.
- **Hypothesis:** C `expire_gas_cloud` prints dissipation; JS omits.
...
- Do not skip D-1071…D-1093 (hugs through MS_LEADER) /
  ...
  `classify_terrain` (D-1151) / skip `rloc_to` `maybe_unhide_at` (D-1152) / vault_tele false (D-1153) / skip `pick_vibrasquare` / hellfill VS (D-1154).
...
- Suite **#1465** **44**/44. Next @**#1470**. **D-1153** `b332516f`.
