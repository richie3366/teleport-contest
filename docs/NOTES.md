...
- **Fortress 44/44** after D-1285 meatcorpse
  (cadence **#1625** `7d61ee8b`; reviews **241–244**
  ACCEPT-WITH-DEBT, no Must-fix). Next: Open `mhitu.c` `missmu`
  `pline_mon` (named from D-1261). Not wildmiss. Do not skip
  D-1285…D-1229. Do not pull skipdrin / pit kick / wildmiss /
  ...
  No FORCE.
- Do not revert D-1217–D-1285. Named omits stay map, not Must-fix.
...
- Do not restore rhack raw-ETX (D-1189). Do not skip D-1190…D-1285.
...
- Do not skip D-1071…D-1285 (index). Named still: skipdrin / pit
  kick; missmu; MEAT_RING; throwit slip /
...
- D-1271: `meatmetal`. **meatobj D-1284**. **meatcorpse D-1285**.
