...
- **Suite 44/44** fortress (cadence **#2130** at `32c02560`). Save-oracle
  ...
  **678–686** ACCEPT-WITH-DEBT (no Must-fix). **Next:** Open
  ...
  Do not skip D-1531…D-1730. Do not re-port D-1675…D-1730.
  Falsify: hidden_gold, not artifact_score (D-1730) or getdir
  CQ_REPEAT (D-1729).
- Named still: Palantir `#if 0`; pit/underwater; clone auto-open yn;
  ...
  choose_stairs / `u_left_shop`; hidden_gold;
...
- Do not restore rhack raw-ETX (D-1189). Do not skip D-1190…D-1730.
...
- Do not restore tut-1 hardcoded keys (D-1065) / skip `tutorial()`
  nhcore (D-1066). Do not skip D-1067…D-1730 (index).
- Do not import `monmove.js` `sticks` for sit. Do not rewrite
  `confer_oc_oprop`. Do not re-port `eyecount`. Do not skip
  D-1520…D-1730. Do not delete emin (**487**). Do not stub
...
- Do not import `wield.js`/`pickup.js`→`polyself.js` for `body_part`
  ...
  `vision_reset`. D-1576…D-1730 in the index. No yn ^P glue /
  ...
  D-1682…D-1730 (index). D-1730 is artifact_score (not hidden_gold /
  get_valuables). D-1729 is getdir CQ_REPEAT (not trailing confdir /
  yn_function_menu). D-1728 is yn_function_menu query_menu (not
...
- D-1730: `artifact_score` `:906–940` count+list. Live `js/end.js`.
  Named: get_valuables / pet HP / DUMPLOG list; hidden_gold Open.
