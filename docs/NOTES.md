...
- **#862:** D-0765 juiblex/`lvlfill_swamp` — prefix **72078→74801**; RNG **74607**.
- **Next @74801:** C nhlib `shuffle` after getbones vs JS `rn2(79)` then
  `walkfrom` — fingerprint next Gehennom maze special (baalz/orcus/
  hellfill/wizard*). Falsify: rng-diff first miss must leave shuffle/`walkfrom`.
...
- Don’t re-apply D-0480 space coerce (D-0483); D-0471…D-0765 done.
- Runner `Screen N/M` = total matches, not prefix length.
- `rng-diff.mjs` runs **seg0 only**; matches `rn2(N)=M` strings only.
- seed5002 **PASS** (write/cmdassist/itemed throw — D-0742).
- D-0743…D-0765 seed0360 peels (…/asmodeus/`hell_tweaks`/juiblex).
...
- seed0006/0007/0398/0373/**seed5006**/ **seed0116** / **seed0361** /
  **seed0367** / **seed0108** / **seed5002** **PASS** (suite **37/44** @#860;
  Scr 8272, RNG 75.99%; seed0360 **74801**/267 after D-0765).
...
- S_KOP / minetn-1/3/4/6/7 / **medusa-2/4** deferred;
  ...
  baalz/orcus/hellfill/wizard*/fakewiz deferred;
  minend-3 / soko2-2 / other bigrm-N deferred;
  **`baalz`/`orcus`/`hellfill`/`wizard*` next** (walkfrom @74801);
