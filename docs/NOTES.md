...
- **#922 D-0801:** Valley arrival + hellish_smoke smell + Gehennom
  wall CLR_RED. seed0360 Scr **561→589**/833; prefix **164→180**.
- **Hypothesis next:** @180 leave-Gehennom map — C remembers BROWN
  DEC walls where JS paints blank (hero_memory / lastseentyp /
  glyphmap after temperature leave), not FORCE.
- **Falsify:** first mismatched cells @180 vs C remembered walls
  after “heat and smoke are gone.”
...
- Don’t re-apply D-0480 space coerce (D-0483); D-0471…D-0801 done.
...
- seed0006/0007/0398/0373/**seed5006**/ **seed0116** / **seed0361** /
  **seed0367** / **seed0108** / **seed5002** **PASS** (suite **37/44**
  @#920 Scr **8525** RNG **644653**/81.31%; seed0360 Scr **589** @#922).
