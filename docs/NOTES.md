...
- Don’t re-apply D-0480 space coerce (D-0483); D-0471…D-0803 done.
...
- @231 vain-push vs cannot-pass — missing Sokoban squeeze (D-0803);
  squeeze must run **after** dest `IS_OBSTRUCTED` (else false pline).
...
- **wizard2** (D-0771); **Wiz-strt** FlipY (D-0776/D-0782);
  ...
  **lit grow minetn/minend** (D-0802); **Sokoban cant_squeeze** (D-0803).
