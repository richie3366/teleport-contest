...
- **Fortress 44/44** after D-1474; cadence **#1850** `3605a281`
  (Scr **11,405** RNG 100%). Next: Open `zap.c`
  `bhit` doorlock WAN_LOCKING/SPE_WIZARD_LOCK
  (named). Not OPENING.
  Do not skip D-1474…D-1229. No FORCE / `wildmiss` wrap /
  trailing `confdir` in shared `getdir`.
- Do not revert D-1217–D-1474. Named still: `see_monsters`
...
- Do not restore rhack raw-ETX (D-1189). Do not skip D-1190…D-1474.
...
- Do not restore tut-1 hardcoded keys (D-1065) / skip `tutorial()`
  nhcore (D-1066). Do not skip D-1067…D-1474 (index).
