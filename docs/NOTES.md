...
- **Fortress 44/44** after D-1504; cadence **#1890** `1f64431d`
  (Scr **11,405** RNG 100%, `38+0.30/turn` R² 0.849). Next: Open
  `dog.c` `mon_arrive` `MIGR_LEFTOVERS` DF_ALL (named). Not
  stolen_booty.
  Do not skip D-1504…D-1229. No FORCE / `wildmiss` wrap /
  ...
  deferred for scope.
- Do not revert D-1217–D-1504. Named still: `any_visible_region`;
  `see_monsters` worm segs / MATCH_WARN / SPFX_WARN conferral;
  dog leftovers; GETOBJ_ALLOWCNT count prefix;
...
- Do not restore rhack raw-ETX (D-1189). Do not skip D-1190…D-1504.
...
- Do not restore tut-1 hardcoded keys (D-1065) / skip `tutorial()`
  nhcore (D-1066). Do not skip D-1067…D-1504 (index).
