...
- **Suite 44/44** fortress. Save-oracle required for tagged restore
  ...
  bill_box_content. Do not skip D-1531…D-1704. Do not re-port D-1675…D-1704.
...
- Do not restore rhack raw-ETX (D-1189). Do not skip D-1190…D-1704.
...
- Do not restore tut-1 hardcoded keys (D-1065) / skip `tutorial()`
  nhcore (D-1066). Do not skip D-1067…D-1704 (index).
- Do not import `monmove.js` `sticks` for sit. Do not rewrite
  `confer_oc_oprop`. Do not re-port `eyecount`. Do not skip
  D-1520…D-1704. Do not delete emin (**487**). Do not stub
...
- Do not import `wield.js`/`pickup.js`→`polyself.js` for `body_part`
  ...
  `vision_reset`. D-1576…D-1704 in the index. No yn ^P glue /
  ...
  D-1682…D-1704 (index): silly_thing / sit grease / `make_glib` /
  ...
  `dopay` multi-shk getpos (`:1814–1856`; mute/Deaf nod named).

## Landmarks (≤15)

- D-1704: `dopay` `:1814–1856` seensk>1 live getpos pay-whom
  (ESC `ECMD_CANCEL`; `cx<0` / self / `!cansee` see|sense / empty
  / `!isshk` Monnam / too-far Shknam). Named: FullyUsedUp;
  traditional itemize ynq; mute/Deaf nod; `bill_box_content`.
- D-1703: `shk_names_obj` `:3412–3445` live `objects()[otyp]`
  ...
  Named: FIRST_OBJECT skip; `bill_box_content`.
