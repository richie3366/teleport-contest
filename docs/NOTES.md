...
- **#766 D-0688 done:** seed0014 @18426 was invent-letter drift after
  nymph steal — JS `assigninvlet` reassigned returned ring (`k`→`q`);
  `Wq` wore ring vs C boots. Also ported `Boots_on` Fumble `rnd(20)`.
  Prefix **18426→18494**, Scr **445→453**.
- **Next:** @18494 C `exercise(attrib.c:509)` `rn2(2)` vs JS
  `moveloop_core` `rn2(76)` (after matching hungry/sounds). Falsify:
  `node scripts/rng-diff.mjs sessions/seed0014-dequa-fountain-explore.session.json`
- **Don’t:** reopen “early movemon / skip distfleeck”; invent letter-
  position getobj; re-break D-0474…D-0688; frame-align; DIAG.

## Don’t re-check (≤15)

- No raw RNG-index / coordinate / ux0 / forced-gettrack in production.
- Rule #2: no `fs`/`path`/`url` in scored `js/` (D-0477).
- Don’t re-apply D-0480 space coerce (D-0483); D-0471…D-0688 done.
...
- D-0676…D-0688: blue DSM / chargen / identify→…→assigninvlet/Boots_on.
...
- Quest: seed0367 **PASS**. seed0014 @18494 = exercise.
