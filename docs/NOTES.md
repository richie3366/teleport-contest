...
- Latest ports: **D-1089**…**D-1118**. Prior **70–73** ACCEPT.
- **Next cluster:** Open `teleok` `tele_jump_ok`/`in_out_region`.
- **Hypothesis:** none live. D-1118 drinksink `polyself` shipped.
...
- **D-1118:** drinksink case 10 `polyself`. Hash filled next commit.
