...
- kick_nondoor SDOOR+helpers / throne+tree STALE-DUPE parks (no js/): D-0985/D-0986 arms all live (`js/dokick.js:528-810`); review-55 C-claims dissolve (short-circuit identical, treefruits[] ≡ table, Soundeffect no-op); `verify` 0 blocked. Falsifier: fresh verify showing a kick_nondoor-owned block.
