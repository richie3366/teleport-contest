...
| Screens matched | **459 / 11,405** (4.02%) |
...
| `seed2200-wizard-quaff-zap-read` | **3018 / 3018** | **90 / 230** |
...
clear shared peels. seed2200 RNG **full**; Scr **90**/230 (next:
farlook stairs @ screen 46). seed0017 next @ 3132 `dog_move`
...
**3132** (`dog_move`). seed2200 RNG **full** (Scr **90**/230 —
next farlook stairs @ screen 46).

- **Bounded unit:** seed2200 **screen** peel (farlook stairs @ 46) /
