...
| Positional RNG calls matched | **165,017 / 792,838** (20.81%) |
...
| `seed0030-ten-diverse-deaths` | **40677 / 105529** | **48 / 1953** |
...
- **Bounded unit:** seed0030 seg4 @2369 — C `ini_inv_adjust_obj`
  `rn2(3)` vs JS `rn2(1)` (next death invent after seg3 FULL). /
...
- **Prefer:** seg4 post-death `ini_inv` peel over quest bones until
...
- **Named omissions:** full `findtravelpath` TEST_TRAV/GUESS/travelmap/
  ...
  **9881→9887**);
  **`monstseesu`/`m_seenres` MAGR** (done D-0235; seg3 **FULL**;
  positional **40677**/105529; next seg4 @2369 `ini_inv_adjust_obj`);
