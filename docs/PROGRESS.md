...
| Positional RNG calls matched | **134,770 / 792,838** (16.99%) |
...
| `seed0030-ten-diverse-deaths` | **13313 / 105529** | **168 / 1953** |
...
seed0361/0373 `getbones` blocked on unbound `^V`/`goto_level`/
`makemaz`. seed0077 chargen + vault fallback + door vision/pick_lock/DEC
open-door (D-0111/D-0112/D-0113) → **PASS**. seed0030 **13313**/105529.
seed0105 RNG **full** (Scr **30**/30).
...
- **Bounded unit:** seed0030 @12968 (`likes_gold`/`mkmonmoney` rn2(5)) /
...
- **Prefer:** seed0030 @12968 / seed0101 Scr
...
- **Named omissions:** full `findtravelpath` TEST_TRAV/GUESS/travelmap/
  ...
  `throws_rocks`; `m_initinv` beyond S_GNOME candle (D-0172) +
  `likes_gold`/`mkmonmoney` (D-0173 next); `set_malign`; telepathy/
