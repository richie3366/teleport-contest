...
- **Bounded unit:** seed0030 @14118 / D-0185 (JS path→`(57,10)` pass_two
  walls vs C `rn2(32)` — dest after @14074 or C ROOM) /
...
- **Prefer:** seed0030 @14118 D-0185 (@14074 dest / C typ) / seed0101 Scr
