...
| Screens matched | **574 / 11,405** (5.03%) |
...
| `seed1150-caveman-explore-move` | **3137 / 3137** | **27 / 51** |
...
seed1150 Scr / seed0017 mfndpos; screen 158 RC path residual).
seed0017 next @ 3132 `dog_move`/`mfndpos`; seed0030 next
`maybe_smudge_engr` @ 6732. Healer seed0016 next `next_ident` @
2493; Caveman seed1150 RNG **full** Scr **27**/51. Priest
...
seed1150 RNG **full** Scr **27**/51. seed2200 RNG
**full** (Scr **199**/230 — next seed0017 / seed1150 Scr).

- **Bounded unit:** seed1150 Scr 27/51 corridor `#` color
  (must not regress seed0900) / seed0017 @ 3132
...
- **Prefer:** seed1150 screens / seed0017 mfndpos over parked D-0006
