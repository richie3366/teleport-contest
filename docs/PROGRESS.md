...
| Positional RNG calls matched | **135,175 / 792,838** (17.05%) |
...
| `seed0030-ten-diverse-deaths` | **13718 / 105529** | **168 / 1953** |
...
seed0361/0373 `getbones` blocked on unbound `^V`/`goto_level`/
`makemaz`. seed0077 chargen + vault fallback + door vision/pick_lock/DEC
open-door (D-0111/D-0112/D-0113) → **PASS**. seed0030 **13718**/105529.
seed0105 RNG **full** (Scr **30**/30).
...
- **Bounded unit:** seed0030 @12907 (`induced_align` rn2(3) vs rn2(2)) /
...
- **Prefer:** seed0030 @12907 / seed0101 Scr
...
- **Named omissions:** full `findtravelpath` TEST_TRAV/GUESS/travelmap/
  ...
  `throws_rocks`; `m_initinv` beyond S_GNOME candle (D-0172); `set_malign`; telepathy/
