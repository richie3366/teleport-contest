...
| Positional RNG calls matched | **171,238 / 792,838** (21.60%) |
...
| `seed0030-ten-diverse-deaths` | **46654 / 105529** | **69 / 1953** |
...
- **Bounded unit:** seed0030 seg5 @3076 — C `rnd(2)` `next_ident` after
  dart-trap miss vs JS `rn2(12)` (after moverock D-0238; seg4 FULL). /
...
- **Prefer:** seg5 dart/`next_ident` peel over quest bones until
...
- **Named omissions:** full `findtravelpath` TEST_TRAV/GUESS/travelmap/
  ...
  **46654**/105529 Scr **69**/1953; next seg5 @3076 `next_ident`);
