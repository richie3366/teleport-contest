...
| Positional RNG calls matched | **162,645 / 792,838** (20.51%) |
...
| `seed0030-ten-diverse-deaths` | **38305 / 105529** | **48 / 1953** |
...
- **Bounded unit:** seed0030 seg3 @9887 — C `rnd(20)` `mattacku`
  (Maganasipi melee after MFAST) vs JS `rn2(8)`. / seed0361/0373
...
- **Prefer:** seg3 post-striking Maganasipi peel over quest
