...
| Screens matched | **853 / 11,405** (7.48%) |
...
| `seed0106-priest-extcmd-sweep` | **4194 / 4194** | **34 / 267** |
...
Scr **34**/267 (next: progressive `# c` extcmd @16). Healer seed0016 next
`next_ident` @ 2493.
...
seed0106 RNG **full** (Scr **34**/267); seed2200 RNG **full**
(Scr **200**/230).

- **Bounded unit:** seed0106 Scr @16 (progressive `# c` extcmd) /
...
- **Prefer:** seed0106 extcmd progressive paint or seed2200
...
- **Named omissions:** Wizard/Priest/Healer `initialspell`; Knight/
  ...
  filter UI; progressive `#` extcmd getline paint; `#chat` other MS_*/shop/wall/priest/
