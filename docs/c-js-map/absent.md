...
- traps, riding, travel partial (`_` cancel + adjacent/greedy; full
  ...
  chat partial (`#chat` wall/SDOOR/statue + MS_BARK; **`dosounds` feature gates + shop envelope** D-0204 + **vault `gd_sound`/`rn2(2)`** D-0208 + **fountain/sink You_hear** D-0303 + **shop You_hear** D-0306 + **swamp You1 / barracks/court-throne/beehive/morgue You_hear / temple_priest / oracle canseemon** D-2196; findgd migrating / Is_sanctum / Soundeffect / temple Hallu pantheon RNG still deferred); **`u_entered_shop` welcome** D-0307 + deserted/angry/Invis/doorway D-1080 (**SetVoice D-1752**; Soundeffect/Hallu shkname named);
