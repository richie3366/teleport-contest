...
- kicking beyond empty-space/`kick_dumb`/`kick_door` CLOSED bust
  (`kick_object`+`bhit` KICKED via D-0988 — box lock/ghitm/hits_bars
  polish still deferred; throne/`fall_through`/tree via D-0986; SDOOR/
  altar/fountain/grave/sink via D-0985);
