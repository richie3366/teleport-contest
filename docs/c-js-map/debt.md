...
| `js/zap.js` | **`zap_over_floor` closed-door/SDOOR/IRONBARS shopdamage + `dobuzz` `pay_for_damage`** (D-0948); ice melt/fountain/WEB/POOL→PIT/cold freeze; `burn_floor_objects`; fireball; explode/apply break-wand other `pay_for_damage` still deferred |
