...
| scoring serialize (contestant) | `js/display.js` `serialize_for_scoring` | partial | Leading inv/uline spaces (D-0129); **glyphless spaces emit NO_COLOR not clearScreen CLR_GRAY** (D-0480); S_altar raw `{` (D-0293); DEC pool `` ` `` vs ROCK_CLASS grave still ambiguous without cell decgfx |
