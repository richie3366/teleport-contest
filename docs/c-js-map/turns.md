...
blank WIN_STATUS during itemed (D-0467; **`itemactions_pushkeys` throw/drop/apply/read/…** D-0742 + **IA_DIP_OBJ `dip_into`** D-1500 + **IA_ADJUST_STACK `adjust_split`** D-1621 + **IA_ADJUST_OBJ / `check_invent_gold`** D-1641;
remaining pushkeys (offer/tip/invoke) / full apply catalogue deferred)**;
