...
**`open_drawbridge`/`close_drawbridge` + music passtune** (D-0977; D-2316: `revive_nasty` live in `js/hack.js` + both dbridge callers, 3 `Soundeffect` in C order, `wall_info` assign, `nokiller` wired; crush stays D-1967, moverock caller D-1859); 
