...
**`find_roll_to_hit` Luck `sgn*((abs+2)/3)`** (D-0272; monk/orc-elf deferred) + encumbrance/`utrap` (D-2142; `uhitm.c:407–411` `near_capacity` penalty + `u.utrap` −3, same edge `invent.js`; poly-Archeologist-92226 107→hurtle_step@110); 
