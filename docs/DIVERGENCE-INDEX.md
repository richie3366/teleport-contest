...
|---|---|---|---|
| D-1383 | fixed | zap.c bhit shade_miss | map-driven Open from D-1354; C `zap.c` `bhit` `:3972–3992` thrown/kicked `shade_miss(&gy.youmonst,mtmp,obj,TRUE,TRUE)` clears mtmp keep flying; callee `uhitm.c` `shade_miss` `:2016–2051` (JS `mhitm.js`, D-1341) + `dmgval` shade/`shade_glare` D-1354; mthrowu is D-1382; JS stub always stopped; live `js/zap.js`; hmon / `mhitm_ad_phys` / M_AP_OBJECT / WEB / throwit fly still named |
