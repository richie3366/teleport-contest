...
|---|---|---|---|
| D-1158 | fixed | `create_gas_cloud_selection` / Cloud room | map-driven; C `region.c:1311–1336` 1×1 bitmap not BFS/`rn1` ttl; `sp_lev.c` `lspo_gas_cloud` 4928–4965; themerms Cloud asleep fog + `des.gas_cloud({selection})`; Ice/Boulder/… fill, `run_regions` geometry, mfndpos `m_poisongas_ok` still named |
