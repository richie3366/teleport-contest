...
|---|---|---|---|
| D-1372 | fixed | allmain.c moveloop DEX u_wipe_engr(rnd(3)) | map-driven Open from D-1360; C `allmain.c:360–361` after invault/amulet `!rn2(40+ACURR(A_DEX)*3)` then `u_wipe_engr(rnd(3))`; JS burned `rnd(3)` only; live `js/allmain.js` + callee `js/engrave.js` D-1051; uhitm/dothrow/dig still named |
