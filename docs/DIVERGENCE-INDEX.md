...
|---|---|---|---|
| D-1223 | fixed | mhitm.c `mdamagem` `troll_baned` `mkcorpstat_norevive` | map-driven; C `monst.h` `troll_baned` + `mhitm.c:1081–1082`/`1090` AT_WEAP\|\|AT_CLAW around `monkilled`; `mkcorpstat` copies `gm.mkcorpstat_norevive` onto `norevive`; `revive` twitches; gulpmm swap / uhitm `hmon_hitmon`+`hmonas` still named |
