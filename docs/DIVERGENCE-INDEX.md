...
|---|---|---|---|
| D-1277 | fixed | dothrow.c `hurtle_step` dest-typ `switch_terrain` | map-driven Open from D-1129; C `dothrow.c:916–917` dest ltyp≠origin after flush then `switch_terrain`; JS occupy then leftover BLev/BFly FROMOUTSIDE; drown / check_special_room / traps / Passes_walls named; **`u_on_rndspot` / objnam wish still named** |
