...
|---|---|---|---|
| D-1509 | fixed | potion.c potion_dip lichen corpse / acid-erode | map-driven Open; C `potion.c` `potion_dip` `:2596–2606` POT_ACID+CORPSE PM_LICHEN wrinkle/hcolor no-poof + `trycall`; `:2638–2643` POT_ACID `erode_obj` ERODE_CORRODE EF_GREASE poof unless ER_NOTHING; JS named omit after D-1501; live `js/potion.js` + callee `js/trap.js` `erode_obj`; worn `set_wear` / INTERNALCMD `#altdip` named; H2O useeit is D-1501 |
