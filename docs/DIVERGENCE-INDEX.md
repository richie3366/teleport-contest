...
|---|---|---|---|
| D-1318 | fixed | objnam.c doname TOOL W_TOOL\|W_SADDLE worn | map-driven Open from D-1308; C `objnam.c:1427–1429` TOOL first arm `owornmask&(W_TOOL\|W_SADDLE)` Concat `" (being worn)"` break (skips leash/candelabrum/lamp/charges); JS live; LEASH `leashmon` / POT_OIL `(lit)` still named |
