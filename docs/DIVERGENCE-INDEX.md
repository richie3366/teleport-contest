...
|---|---|---|---|
| D-1306 | fixed | eat.c eat_brains | map-driven Open from D-1298; C `eat.c:601–754` tentacle side-effects (`rnd(10)` before DEADMONSTER/noncorporeal; hero conducts/mindless/rider/`morehungry`+INT/`maybe_cannibal`; mhitu/mhitm branches in the function); JS `eat.js` + uhitm headed `mhitm_ad_drin` call; helmet / `m_slips_free` / lifsav skipdrin / mhitu+mhitm callers still named |
