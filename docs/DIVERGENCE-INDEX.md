...
|---|---|---|---|
| D-1364 | fixed | zap.c zapyourself WAN/SPE_MAGIC_MISSILE | map-driven Open; C `zap.c` `zapyourself` `:2790–2802` learn + Antimagic `pline_The` bounce (no `d()`) else `d(4,6)`+Idiot; JS defaulted; live `js/zap.js`; SPE_FIREBALL / `lightdamage` / WAN_MAKE_INVISIBLE / AD_ELEC destroy body still named |
