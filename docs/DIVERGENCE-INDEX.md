...
|---|---|---|---|
| D-1264 | fixed | uhitm.c AT_ENGL `gulpum` | map-driven Open from D-1251; C `uhitm.c:4958–5194` `gulpum` + `start_engulf`/`end_engulf` + `hmonas` `:5769–5794` `rnd(20+i)`; JS was AT_ENGL `continue`; fight_empty `explum` / altwep still named |
