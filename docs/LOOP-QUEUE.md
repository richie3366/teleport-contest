...
- [ ] `muse.c` mreadmsg — coverage PARTIAL (C 52 L `muse.c:238–290` / JS 36 L in js/muse.js; hops 2, callers 6, RNG 0, msg 3). Port the whole C body in C order — every arm, every callee live or named in the map, every C caller wired. Verify `node scripts/verify.mjs --fn mreadmsg` (reach regression must be 0). Measured `port-coverage.mjs --name mreadmsg` 2026-09-19 @ d57c144b.
