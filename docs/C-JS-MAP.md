...
positional RNG **2937**/3137 Scr **22**/51. Next peel: shared
`mkclass_aligned` / `choose_trapnote` / `hole_destination` /
`wipeout_text` / `lspo_map` / `next_ident` / `rndmonst_adj`, or
GEM `oclass_prob_totals` off-by-one. `make_corpse` body and
