...
Next peel: seed0030 seg2 @2408 (D-0211: extra `dog_move` `rn2(12)` —
JS cnt=8 includes SW diagonal C skips; need `mfndpos` typ/region
falsifier or poison-gas `visible_region_at`) / quest `makemaz` /
