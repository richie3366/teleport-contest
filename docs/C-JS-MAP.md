...
**104575**/792838.
Next peel: seed0106 Scr @16 (progressive `# c` extcmd) /
...
| `src/pline.c` / tty message behavior | `js/display.js`, `js/input.js` | partial | `--More--` works for green paths + getobj re-prompt (D-0025); **`verbalize`/`You_feel`** (D-0116); full message/window policy incomplete |
