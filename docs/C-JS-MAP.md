...
Next peel: seed0015 `trapeffect_pit` / seed0101/0103 `next_ident` /
seed0030 `maybe_smudge_engr` / seed0200 combat @3382 /
quest `makemaz` (ordinary `goto_level` exists; special levels still
blocked) / parked seed2200 RC @158.
