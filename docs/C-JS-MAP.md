...
Next peel: seed0030 @14299 (after D-0189 `dmgval`; C `can_make_bones`
vs JS `rn2(5)` — hero death/HP after matched kill blow) /
seed0101 Scr residual /
seed0200 combat @3387 / quest `makemaz` / parked seed2200 RC @158.
