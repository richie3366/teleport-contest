...
**`postmov` door open/unlock/smash** (D-0159) → seed0015 Scr
**21→22**/44; full **14/44** Scr **1324** RNG **128111**.
Next peel: seed0015 descend `--More--` @19 / seed0030 `maybe_smudge_engr` /
