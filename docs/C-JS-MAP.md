...
| `src/fountain.c` | `js/fountain.js` | partial | **`dipfountain` case 16/default + `dryup` rn2(3)** (D-0109); **`drinkfountain` fate=rnd(30)/mgkftn/fate<10/default+message arms + dryup** (D-0237); omit Excalibur body, wash_hands, dip cases 17–29, snakes/demon/nymph/gem/`rnd_class` gush (D-0263 open @seg9 8138), detect/enlightenment/vomit bodies, town warn/`angry_guards`, wizard yn |
