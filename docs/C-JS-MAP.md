...
Next peel: seed0103 @2440 `mount_steed` (D-0212 saddle done;
prefix **2337→2440**) / seed0030 seg2 @2408 (D-0211: extra `dog_move`
...
| `src/steed.c` | `js/steed.js` | partial | **`can_saddle` + `put_saddle_on_mon`** (NULL→`mksobj(SADDLE)` + identify + wear; D-0212); omit `doride`/`mount_steed`/`dismount_steed`, whirly/unsolid, full `which_armor`, `update_mon_extrinsics`, `use_saddle` |
