...
Next peel: seed0200 `random_engraving`/`get_rnd_text` / seed0015 `getbones` /
seed0101/0103 `next_ident` /
seed0030 `maybe_smudge_engr` / quest `getbones` (blocked on `^V`/`makemaz`) /
