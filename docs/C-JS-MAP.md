...
Next peel: seed0030 seg2 @2930 `eatcorpse` / quest `getbones`
...
CORPSE `eatcorpse`/`eatfood` done (D-0193; TIN/floorfood/cprefx deferred);
...
| `js/eat.js` | Cookie + reqtime-1 `touchfood`/`fprefx` (D-0155); **CORPSE `eatcorpse`/`eatfood`** (D-0193); TIN/floorfood/`cprefx` still deferred |
