...
Next peel: seed0015 `getbones` / seed0101/0103 `next_ident` /
seed0030 `maybe_smudge_engr` / seed0200 combat @3382 /
quest `getbones` (blocked on `^V`/`makemaz`) /
