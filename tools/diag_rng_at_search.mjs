...
const origPush = globalThis.__rngPushHook;
const events = [];
globalThis.__rngPushHook = (entry) => {
    events.push({ i: events.length, len: getRngLog().length, entry });
    if (origPush) origPush(entry);
};
