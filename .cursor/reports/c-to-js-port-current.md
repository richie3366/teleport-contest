...
**Last slice:** **`monattk.h`** **`AD_*`** alignment in **`destroy_items.js`** (**`AD_ELEC`** **6** was wrongly **5** = C **`AD_DISN`**); exported **`AD_DISN`**/**`AD_ACID`**; **`adtypToPropDestroyItemsLikeC`** → **`DISINT_RES`**/**`ACID_RES`**. Wizard **`extcmd.js`** **`#i`**/**`#I`**: same **`u_adtyp`**/**`item_what`** flow for fire/cold/**disintegration**/shock/**acid** + updated fallback pline. **`npm run score`:** **0/44**; **`seed0060`** **991/3626** (unchanged).
