...
**Last slice:** **`u_init_role_rng.js`** (**`mksobj_init`** **`WEAPON_CLASS`** — C **`mkobj.c`** **`is_multigen`** **`rn1(6,6)`** + **`weaponAmmoMultigenOrPoisonableLikeC`** for NH5 projectiles **`otyp`** **19–24** omitted from **`OC_SKILL_ROW_BY_OTYP`**) + **`consumeRangerHumanIniInvUinitRoleRngLikeC`** — C **`u_init.c`** **`PM_RANGER`** **`ini_inv(Ranger[])`**: dagger/bow (**`trquan`**/**`mksobj_init`**/**second `trquan`**), two **ARROW** stacks (**50–59** / **30–39**), **`CLOAK_OF_DISPLACEMENT`**, cram × **`4+rn2(1)`** (**`!rn2(6)`** quan each + Monk-style **`rn2(1)`** tail). **`u_init_link_ranger_invent.js`**: **`uwep`/`uswapwep`/`uquiver`/`uarmc`**, **`findAc`**. **`fastforward_post_mklev`** human **`Ran`**; **`ini_inv_stub`** dynamic arrow/cram lines + linker. **`npm run score`:** **0/44**; **`seed1150`** **335/3137** RNG; **`seed0373`** **278/35386**; **`seed0002`** **357/27158**; **`seed0030`** **5219/105529**; **`seed0108`** **250/16958**; **`seed0116`** **322/12562**; **`seed0360`** **320/120639**; **`seed0006`** **280/6736**, **24/123**; **`seed0077`** **1507/3242**, **11/33**; **`seed0012`** **462/13878**, **12/308**; **`seed0004`** **539/12084**, **7/409**; **`seed1500`** **976/2768**; **`seed8000`** **2931/3130**, **2/23**; **`seed0014`** **170/59178**, **10/714**; **`seed0361`** **262/53865**; **`seed0017`** **324/3465**, **8/67**; **`seed0700`** **358/3230**; **`seed0101`** **986/2371**, **0/27**; **`seed0102`** **1214/4485**.

## Next steps

1. **Chargen** — next **`trobj[]`** role (**`Priest[]`**, …) **`ini_inv`** + **`fastforward`** + linker; refine **human Monk** / **Wizard** RNG (**`ini_inv_adjust_obj`** charged-ring **`rne(3)`** when **`spe<=0`**, blindfold/`trquan` edge parity) if sessions diverge; wire **`#pray`** / priest donation to **`divine_protection.js`**; **`seed0006`** / **`pick_*`**; **`u_init.c`** **`knows_object`** post–Samurai (no RNG) if discovery order matters.
