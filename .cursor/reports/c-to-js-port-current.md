...
**Last slice:** **`allmain.js`** / **`roles.js`** / **`chargen_tty.js`** / **`vision.js`** — C **`allmain.c`** **`welcome(TRUE)`** **`buf`**: append **`genders[currentgend].adj`** only when **`!gu.urole.name.f`** in C (here **`roleHasFemaleRoleNameLikeC`** false) and **`allows.gender === 'any'`** (both sexes); role title uses **`name.f`** only for **Cav** / **Pri** when female (**`role.c`** **`roles[]`**). **`genders[].adj`** (**`male`**/**`female`**). **`pline`** format **`You are a%s.`** with leading space in buf. **`newgame`** tail: **`dolookaroundLikeC`** if **`a11y.glyph_updates`**, else **`noticeAllMonsLikeC(true)`** (C XOR). **`npm run score`:** **0/44**; **`seed0006`** **519/6736** RNG, **23/123** screens; **`seed0012`** **405/13878** RNG, **12/308** screens; **`seed0077`** **1507/3242** RNG, **11/33** screens; **`seed8000`** **2931/3130** RNG, **2/23** screens; **`seed0014`** **170/59178** RNG, **9/714** screens.
