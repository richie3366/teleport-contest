...
**Last slice:** **`divine_protection.js`** — C **`pray.c`** **`pleased`** gift Protection / **`angrygods`** **`u.ublessed`**, **`priest.c`** donation **`HProtection`** + ublessed loop, **`sit.c`** strip intrinsic; **`u_init_role_rng.js`** **`consumeIniInvBlindfoldLeafRngIfGateLikeC()`** (same RNG as inlined). **`allmain.js`** comment pointer. No new call sites. No RNG. **`npm run score`:** **0/44**; **`seed0077`** **1507/3242** RNG, **11/33** screens; **`seed0002`** **351/27158**; **`seed0006`** **280/6736**, **24/123**; **`seed8000`** **2931/3130**, **2/23**; **`seed0014`** **170/59178**, **10/714**; **`seed1500`** **976/2768**.

## Next steps

1. **Chargen / tty + early game** — extend **`g.invent`** to other roles from C **`trobj`**; wire **`#pray`** / priest donation to **`divine_protection.js`**; **`seed0006`** / **`pick_*`**; Samurai/Wizard blindfold gate via **`consumeIniInvBlindfoldLeafRngIfGateLikeC`** when role-specific **`u_init_role`** RNG is replayed (not only Rogue).
