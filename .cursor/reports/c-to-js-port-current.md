...
1. **Lane C — `seed0006` comma-`U` post-fifth surplus hostile tail @ ~3082+** — pet **`dog_move`** **~3077–3081** aligned; next **`distfleeck`**×2 + **`m_move`** on surplus hostiles. Locator: `node tools/diag_rng_window.mjs sessions/seed0006-wizard-water-demon.session.json 3078 3100`.
