...
**Last slice:** **`u_init_link_monk_invent.js`** + **`consumeMonkHumanIniInvUinitRoleRngLikeC`** + **`mkobj_scroll_class_rng_like_c.js`** — C **`u_init.c`** **`Monk[]`** **`ini_inv`** + **`PM_MONK`** tail: **`trquan`/`mksobj_init`** (gloves **160** / robe **144**, **`mkobj(SCROLL_CLASS)`** + **`ini_inv_mkobj_filter`** via frozen **`SCROLL_CLASS_MKOBJ_OC_PROB_ROWS`** sum **1000**), potions ×**`3+rn2(1)`**, rations ×**`3+rn2(1)`**, apples/oranges **`5+rn2(1)`**, fortune **`3+rn2(1)`**, **`M_spell[rn2(90)/30]`** spellbook **`blessorcurse(17)`**, **`!rn2(4)`** marker **`rn1(70,30)`** + **`19+rn2(4)`** **`spe`**, **`else if (!rn2(10))`** lamp. Linked **`g.invent`**, **`u.uarm`/`u.uarmg`**, **`findAc`**. **`fastforward_post_mklev`** human Monk branch. **`fix(js): bhit_throw_hero`** — import **`NH5_POTION_CLASS`** (was **`ReferenceError`** on **`seed0004`** / **`seed5006`**). **`npm run score`:** **0/44**; **`seed0077`** **1507/3242** RNG, **11/33** screens; **`seed0002`** **351/27158**; **`seed0006`** **280/6736**, **24/123**; **`seed8000`** **2931/3130**, **2/23**; **`seed0014`** **170/59178**, **10/714**; **`seed1500`** **976/2768**; **`seed0015`** **359/8563**; **`seed0105`** **956/2499**; **`seed0017`** **325/3465**, **8/67**; **`seed0107`** **1102/2902**; **`seed0700`** **361/3230**; **`seed0030`** **5227/105529**; **`seed0103`** **1192/2640**; **`seed0104`** **1270/3223**; **`seed4500`** **224/108275**; **`seed0012`** **462/13878** RNG, **12/308** screens (was **463/13878**); **`seed0004`** **539/12084** RNG, **7/409** screens (was **0/12084**).

## Next steps

1. **Chargen / tty + early game** — extend **`g.invent`** + **`fastforward`** to **`Wizard[]`** (**`UNDEF_TYP`** wand/ring/potion/scroll/spellbook + **`mkobj`** loops, blindfold **`!rn2(5)`**); refine **human Monk** RNG if **`seed0012`**/**`seed0200`** still diverge; wire **`#pray`** / priest donation to **`divine_protection.js`**; **`seed0006`** / **`pick_*`**; **`u_init.c`** **`knows_object`** post–Samurai (no RNG) if discovery order matters.
