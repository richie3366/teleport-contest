...
**Last slice:** Wizard D:1 second **`L`** post-peel pet **`mfndpos`** — C **`dog_goal`** **`appr`** via **`dogGoalFollowGxGyApprLikeC`** (skip **`rn2(4)`** when **`_wizD1LPetMfndposAfterEastTailPeelLikeC`**) then **`dogmove.c`** ~1254–1257 pick (**`rn2(3)`**/**`rn2(12)`**). **`dogmove_mon.js`**. **`seed0006`** **2795/6736** (diag **2722–2730**; **~2731+** corridor **~(10,11)**). **2/44**.
...
1. **Lane C — `seed0006` ~2731+** — corridor mklev **~(10,11)** **`m_move`** / **`mfndpos`** after post-peel pet (**`rn2(5)`** ~2731); peel **2722–2730** aligned. Lane A: **`chargen_tty.js`** when rc omits identity.
