...
**Last slice:** **`mkobj` FOOD ini-inv vs C** — **`js/mons_rndmonst_ini_inv_data.js`**: generated **`mons[0..SPECIAL_PM-1]`** **`geno`** (Plan B), **`rndmonst`** fields, **`little_to_big`**. **`mkobj_food_class_rng_like_c.js`**: **`rndmonstIniInvSurfaceLikeC`**; Plan B **`G_HELL`** when **`!Inhell`**; candy **`1+rn2(12)`**; tin **`rn2(15)`** + non-rotting remap; corpse one **`rndmonnum`** per iteration; **`canBeHatchedIniInvLikeC`** incl. breeder **`!rn2(77)`**; corpse-exhaust comment (**`PM_HUMAN`** no extra RNG). **`npm run score`:** **0/44**; **`seed8000`** **2917/3130** RNG, **1/23** screens; **`seed0030`** **5148/105529**; **`seed5006`** **564/13923**; **`seed1150`** **335/3137**; **`seed0373`** **278/35386**; **`seed0002`** **357/27158**; **`seed0108`** **250/16958**; **`seed0116`** **322/12562**; **`seed0360`** **320/120639**; **`seed0006`** **280/6736**, **24/123**; **`seed0077`** **1507/3242**, **11/33**; **`seed0012`** **462/13878**, **12/308**; **`seed0004`** **539/12084**, **7/409**; **`seed1500`** **976/2768**; **`seed0014`** **170/59178**, **10/714**; **`seed0361`** **262/53865**; **`seed0017`** **324/3465**, **8/67**; **`seed0700`** **358/3230**; **`seed0101`** **986/2371**; **`seed0102`** **1214/4485**; **`seed0106`** **343/4194**; **`seed0367`** **303/50125**; **`seed0501`** **273/2238**; **`seed0900`** **351/2983**; **`seed1800`** **285/2458**.

## Next steps

1. **Chargen** — FOOD ini-inv: wire **`mvitals`/`dead_species`** when **`egg`**/**`corpsenm`** state is modeled; **`human Monk` / `Wizard`** charged-ring **`rne(3)`**; wire **`#pray`** / priest donation to **`divine_protection.js`**; **`seed0006`** / **`pick_*`**; **`u_init.c`** **`knows_object`** post–Samurai if discovery order matters.
