...
**Last slice:** **Lane A/D `seed0900` run-east `L` post (~2814–2827)** — diag **2814–2827** match. Twelfth **`movemon`** (fourth phase-2 budget 6 + third phase-3 shell); arm twelfth after eleventh new-turn. **Open:** **~2828** — thirteenth **`movemon`**. **`seed8000`:** **PASS**. **2/44**.
...
1. **Lane A/D — `seed0900` ~2828** — thirteenth **`movemon`** (**`distfleeck`** + invent/**`mfndpos`** ~2828–2850). Diag **2828–2870**; mirror eleventh arm/skip pattern.
