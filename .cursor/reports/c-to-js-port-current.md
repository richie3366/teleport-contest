...
**Last slice:** **`sp_levchn.js`** / **`moveloop_preamble.js`** — **`findLevelByProtoLikeC`** mirrors C **`dungeon.c`** **`find_level(const char *s)`** (walk **`g.sp_levchn`**, case-insensitive **`proto`**). **`findLevelTut1LikeC`** calls it for **`"tut-1"`** instead of always **`null`** (still **`null`** until **`tut-1`** is linked like C). **`npm run score`:** **0/44**; **`seed0006`** **519/6736** RNG, **23/123** screens; **`seed0012`** **405/13878** RNG, **12/308** screens; **`seed0077`** **1507/3242** RNG, **11/33** screens; **`seed8000`** **2931/3130** RNG, **2/23** screens; **`seed0014`** **170/59178** RNG, **9/714** screens.
