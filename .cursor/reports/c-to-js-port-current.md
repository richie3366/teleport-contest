...
**Last slice:** **`chargen_tty.js`** — **`roleHubRightColumnLikeC`**: use tty **right column** (**`MENU_COL`**) when **`gotChargenRfilterLikeC()`** even if role/race/gender/align are still **`ROLE_NONE`**, matching C **`wintty`/`role.c`** after **`reset_role_filtering`** apply (**`seed0006`** step **41**: CSI column **41** for title/recap/extras + **`(end)`** cursor col **47**). **`npm run score`:** **0/44**; **`seed0006`** **131/6736** RNG, **19/123** screens, **20/123** cells, **32/123** cursors; **`seed0012`** **405/13878** RNG, **9/308** screens; **`seed0077`** **1507/3242** RNG, **9/33** screens; **`seed8000`** **2931/3130** RNG, **2/23** screens.

## Next steps

1. **Chargen / tty remainder** — **`seed0006`** / chargen **screen+cursor** tail after post-filter role hub (**`w`/`o`/`f`** path, options); **`rfilter`** edge cases vs C bitmask when needed; other overlays vs **`wintty.c`**.
