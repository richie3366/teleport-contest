...
**Last slice:** **Batch 2** — deleted `_wizD1CommaPostEighth*` inline peel; post-eighth pass via `movemonSinglemonLikeC` (`mon.c`). `seed0006` 3140–3175 + three canaries aligned.
...
1. **P2 — PostNinth peel** — same pattern as batch 1–2; delete `_wizD1CommaPostNinth*` inline peel + `mons=[]` when `seed0006` ~3175–3210 + canaries pass. Oracle: [`c-oracles/monmove.c.md`](c-oracles/monmove.c.md).
