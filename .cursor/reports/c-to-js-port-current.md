...
**Last slice:** **`moveloop_preamble.js`** / **`jsmain.js`** — C **`allmain.c`** **`moveloop()`**: call **`maybe_do_tutorial()`** after **`moveloop_preamble(false)`** and before the **`moveloop_core`** loop. Stub **`findLevelTut1LikeC`** (**`find_level("tut-1")`**), **`askDoTutorialLikeC`** (**`options.c`** **`ask_do_tutorial`**: **`tutorial_set_in_config`** → **`flags.tutorial`**; menu path TODO when tut level exists), **`maybeDoTutorialLikeC`** (**`schedule_goto`** / **`deferred_goto`** deferred). **`npm run score`:** **0/44**; **`seed0006`** **519/6736** RNG, **23/123** screens; **`seed0012`** **405/13878** RNG, **12/308** screens; **`seed0077`** **1507/3242** RNG, **11/33** screens; **`seed8000`** **2931/3130** RNG, **2/23** screens; **`seed0014`** **170/59178** RNG, **9/714** screens.
