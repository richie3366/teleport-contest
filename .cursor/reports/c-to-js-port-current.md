...
**Last slice:** **`allmain.js`** — C **`u_init.c`** welcome **`pline`**: role-specific first word (**`Hello`** default; **`Aloha`** Tourist; **`Konnichi wa`** Samurai; **`Velkommen`** Valkyrie; **`Salutations`** Knight) instead of always **`Aloha`**. **`npm run score`:** **0/44**; **`seed0006`** **519/6736** RNG, **23/123** screens, **23/123** cells, **34/123** cursors; **`seed0012`** **405/13878** RNG, **12/308** screens; **`seed0077`** **1507/3242** RNG, **11/33** screens; **`seed8000`** **2931/3130** RNG, **2/23** screens.
