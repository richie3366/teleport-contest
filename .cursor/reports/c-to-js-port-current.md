...
**Last slice:** **Lane C — `seed0006` deferred comma distant `m_move` start (~2830–2831)** — **`mMoveCapitalKPostCommaDeferredDistantLikeC`** in inline comma peel after pet invent tail; no leading distant **`distfleeck`**; ~915 recalc (~2839). **Verified:** **2810–2831**; prefix **73** **2830**; first fail **2832** distant **`mfndpos`** tail **`rn2(20)`** + chcnt (**2832–2838**); **`seed8000` 2900–3129** canary. **2/44**.
...
1. **Lane C — `seed0006` comma move 73+** — finish deferred distant **`m_move`** **`mfndpos`** tail **2832–2838** ( **`mtrack`** **`rn2(20)`** + chcnt debt); second inline **`mcalcmove`** **2840–2847**; full invent **`obj_resists`** **~2910+**; comma peel toward C **2908**; comma-**`U`** **~3054** when window green.
