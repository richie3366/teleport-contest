...
**Last slice:** **Lane A/D `seed0900` run-east `L` post (~2707–2729)** — diag **2620–2729** match. Seventh **`movemon`** (fourth invent/**`mfndpos`** shell, seventh phase-1 pair-pad); arm/skip after sixth new-turn. **Open:** **~2730** — eighth **`movemon`** (same shell). **`seed8000`:** **PASS**. **2/44**.
...
1. **Lane A/D — `seed0900` ~2730** — eighth **`movemon`** (**`distfleeck`** + 5× invent + **`mfndpos`** ~2730–2748). Diag **2730–2770**; mirror seventh arm/skip pattern.
