...
**Last slice:** **`botl.c`** **`rank()`** / **`rank_of`** + **`role.c`** nine experience titles — **`role_ranks_like_c.js`**; **`roles.js`** **`ranks`**, **`xlevToRankLikeC`**, **`rankOfRoleLikeC`**, **`rankHeroTitleLikeC`**; **`display.js`** status line 1; **`overlay_screens.js`** / **`legacy_intro_paint.js`**. **`npm run score`:** **0/44**; **`seed0002`** **351/27158** RNG; **`seed0006`** **280/6736** RNG, **24/123** screens; **`seed0007`** **103/16373** RNG, **8/302** screens (**cursors** **10/302**); **`seed0077`** **1507/3242** RNG, **11/33** screens (**cursors** **15/33**); **`seed8000`** **2931/3130** RNG, **2/23** screens; **`seed0014`** **170/59178** RNG, **10/714** screens; **`seed1500`** **978/2768** RNG.

## Next steps

1. **Chargen / tty + early game** — **`seed0077`**: C **`acurr`** (**`u.abon`/`u.atemp`/`u.acurr`**) vs JS minimal **`acurr`**; real **`gi.invent`** / **`ini_inv`** for **`inv_weight`**; **`seed0006`** / **`pick_*`** as before.
