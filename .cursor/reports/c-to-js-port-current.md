...
**Last slice:** **`display.js`** / **`cmd.js`** / **`allmain.js`** / **`extcmd.js`** — C **`win/tty/topl.c`** **`update_topl`**: when a new **`pline`** fits on the tty topline with **`"  "`** between segments and room for **`--More--`** (**`n0 + strlen(gt.toplines) + 3 < CO - 8`**), concatenate like **`gt.toplines`** instead of replacing (**`You die…`** exempt). **`clearPendingMessageAndToplineLikeC`** resets **`_toplineAccum`** / **`_toplineNeedMore`** with **`_pending_message`** on **`cls`**, overlay/inventory, ESC, **`#`** extcmd tail, domove, post-command clear. **`npm run score`:** **0/44**; **`seed0006`** **519/6736** RNG, **23/123** screens; **`seed0012`** **405/13878** RNG, **12/308** screens; **`seed0077`** **1507/3242** RNG, **11/33** screens; **`seed8000`** **2931/3130** RNG, **2/23** screens; **`seed0014`** **170/59178** RNG, **9/714** screens.

## Next steps

1. **Chargen / tty + early game** — **`seed0006`** / **`seed0077`** remaining screen deltas (**`--More--`**, dungeon map, …); **`pick_*`** / **`rigid_role_checks`** if RNG still diverges mid-chargen.
