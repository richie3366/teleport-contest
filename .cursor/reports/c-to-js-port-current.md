...
**Last slice:** **`goto_level_hero.js`** — C **`do.c`** **`goto_level`**: after **`keepdogs(FALSE)`** (when **`!nofollowers`**), **`vision_recalc(2)`** before **`u.uz`** is reassigned — same phase as C before **`savelev`** (**“no longer see old level”**). Applied in **`applyGotoLevelDirectHeroLikeC`**, **`applyGotoAfterHeroHoleFallLikeC`**, **`applyHeroDescendStairsOneLevelLikeC`**. **`npm run score`:** **0/44**; **`seed0006`** **519/6736** RNG, **23/123** screens; **`seed0012`** **405/13878** RNG, **12/308** screens; **`seed0077`** **1507/3242** RNG, **11/33** screens; **`seed8000`** **2931/3130** RNG, **2/23** screens; **`seed0014`** **170/59178** RNG, **9/714** screens.
