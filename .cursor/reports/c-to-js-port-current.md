...
**Last slice:** **`PICK_ONE` `n==2` on race / gender / align `*`** (**`role.c`** ~2422, ~2510, ~2596) — **`chargen_tty.js`**: **`chargenStarPickOneN2LikeC`** (same semantics as role hub **`*`**) used by **`readRaceChoice`**, **`readGenderChoice`**, **`readAlignChoice`**. **`npm run score`:** **0/44**; **`seed0006`** **131/6736** RNG, **0/123** screens; **`seed0077`** **1507/3242** RNG, **3/33** cells; **`seed0012`** **405/13878** RNG, **1/308** cells; **`seed8000`** **2931/3130** RNG, **2/23** screens.

## Next steps

1. **Chargen / tty remainder** — **SGR** / ANSI frozen-row parity vs **`wintty.c`**; **`seed0006`** / **`seed0077`** harness vs C where chargen still diverges.
