...
**Last slice:** **`insight.c`** **`item_resistance_message`** (subset) + **`zap.c`** **`item_what`** — wizard **`extcmd.js`** **`#i`**/**`#I`**: **`uAdtypResistanceObjPercentHeroLikeC`** per **`AD_FIRE`**/**`AD_COLD`**/**`AD_ELEC`**, **`somewhat`** when **`< 99`**, append **`itemWhatAdtypInventoryProtectWizardLikeC`**; fallback pline when none. **`npm run score`:** **0/44**; **`seed0060`** **991/3626** (unchanged).
