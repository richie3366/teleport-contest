...
**Last slice:** **Chargen tty recap / `role forces` / `race forces` + confirm column** — **`chargen_tty.js`**: **`role.c`-style** pinned **gender**/**alignment** in race recap; **`race forces`** vs **`role forces`** on gender menu from **orc** vs role-only narrowing; **`[`** hub line only when alignment still open; **Valkyrie** branch order (**`?`** → **`role forces female`** → **`[`**). **`confirmMenuStartColLikeC`** (**`wintty`**) shifts confirm block when recap is wide (**seed0006** col **38**). **`npm run score`:** **0/44**; **`seed0006`** **131/6736** RNG, **4/123** screens, **4/123** cells, **6/123** cursors; **`seed0077`** **1507/3242** RNG, **3/33** screens, **3/33** cells, **7/33** cursors; **`seed0012`** **405/13878** RNG, **1/308** screens; **`seed8000`** **2931/3130** RNG, **2/23** screens.

## Next steps

1. **Chargen / tty remainder** — Remaining screen diffs (splash, align menu extras, SGR nuance); **`seed0006`** / **`seed0077`** still not full-screen match.
