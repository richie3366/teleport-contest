...
**Last slice:** **`allmain.js`** — **`welcome()`** **`pline`**: single space after **`NetHack!`** before **`You are a%s.`** (**C `allmain.c`** **`"… welcome to NetHack! You are a%s."`**); JS had an extra space (**`NetHack!  You`**). **`npm run score`:** **0/44**; **`seed0006`** **519/6736** RNG, **23/123** screens; **`seed0012`** **405/13878** RNG, **12/308** screens; **`seed0077`** **1507/3242** RNG, **11/33** screens; **`seed8000`** **2931/3130** RNG, **2/23** screens; **`seed0014`** **170/59178** RNG, **9/714** screens.
