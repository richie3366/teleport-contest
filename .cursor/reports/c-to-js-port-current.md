...
**Last slice:** **Batch 10** — deleted `_wizD1CommaPostSixteenth*` inline peel; post-sixteenth pass via `movemonSinglemonLikeC` (`mon.c`). `seed0006` 3391–3422 + three canaries aligned.
