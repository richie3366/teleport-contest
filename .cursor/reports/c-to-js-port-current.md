...
**Last slice:** **`chargen.js`** — **`applyIdentityFromNethackrc`**: copy **`urole.allows`** (**`align`**, **`races`**, **`gender`**) from **`roles[]`** onto **`g.urole`** so **`allmain.js`** **`welcomeBufLikeC`** can apply C **`ROLE_MALE|ROLE_FEMALE`** gating (**`genders[].adj`** when **`allows.gender === 'any'`**). Previously **`allows`** was missing so the branch never ran. **`npm run score`:** **0/44**; **`seed0006`** **519/6736** RNG, **23/123** screens; **`seed0012`** **405/13878** RNG, **12/308** screens; **`seed0077`** **1507/3242** RNG, **11/33** screens; **`seed8000`** **2931/3130** RNG, **2/23** screens; **`seed0014`** **170/59178** RNG, **9/714** screens.
