...
**Last slice:** **Batch 4** — deleted `_wizD1CommaPostTenth*` inline peel; post-tenth pass via `movemonSinglemonLikeC` (`mon.c`). `seed0006` 3220–3245 + three canaries aligned.
...
1. **P2 — PostEleventh peel** — same pattern as batches 1–4; delete `_wizD1CommaPostEleventh*` inline peel + `mons=[]` when `seed0006` ~3246–3262 + canaries pass. Oracle: [`c-oracles/monmove.c.md`](c-oracles/monmove.c.md).
