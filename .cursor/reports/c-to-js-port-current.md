...
**Last slice:** **`botl.c`** **`get_strength_str`** — **`attrib.js`** **`getStrengthStrLikeC()`** formats **St:** on **`do_statusline1`** like C (**`18/xx`**, **`18/**`**, **`19`–`25`** when **ACURR(A_STR) > 18**); **`display.js`** **`_statusLine1`** wires it. Full status parity still needs C **`acurr`** (**`abon`/`atemp`**) + real **`invent`** weights; **`rank()`** female title vs **`rank.m`** only. **`npm run score`:** **0/44**; **`seed0002`** **351/27158** RNG; **`seed0006`** **280/6736** RNG, **24/123** screens; **`seed0007`** **103/16373** RNG, **8/302** screens (**cursors** **10/302**); **`seed0077`** **1507/3242** RNG, **11/33** screens (**cursors** **15/33**); **`seed8000`** **2931/3130** RNG, **2/23** screens; **`seed0014`** **170/59178** RNG, **10/714** screens; **`seed1500`** **978/2768** RNG.

## Next steps

1. **Chargen / tty + early game** — **`seed0077`**: C **`acurr`** (**`u.abon`/`u.atemp`/`u.acurr`**) and **`rank()`** title (**`flags.female`** / **`urole.rank.f`**); real **`gi.invent`** / **`ini_inv`** for **`inv_weight`**; **`seed0006`** / **`pick_*`** as before.
