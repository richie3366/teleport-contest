...
**Last slice:** **Batch 1** — deleted `_wizD1CommaPostSeventh*` inline peel; post-seventh pass via `movemonSinglemonLikeC` (`mon.c`). `seed0006` 3100–3145 + three canaries aligned.
...
1. **P2 — PostEighth peel** — same pattern as batch 1; delete `_wizD1CommaPostEighth*` inline peel + `mons=[]` when `seed0006` ~3140–3175 + canaries pass. Oracle: [`c-oracles/monmove.c.md`](c-oracles/monmove.c.md).
