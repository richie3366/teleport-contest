...
**Last slice:** **P2 — comma-`U` fifteenth `movemon` + inline new-turn (`seed0006`)** — **`moveloop_turn_advance.js`**: post-fourteenth inline → fifteenth **`movemon`** (fix premature outer-loop done after fourteenth); **`monmove.js`**: fifteenth peel explicit (~3340–3387); **`moveloop_aux.js`**: **`runCommaUPostFifteenthInlineNewturnLikeC`**. Locator **`seed0006` 3340–3390**; fail **3391+** sixteenth **`movemon`**. Canaries **PASS**.
...
1. **P2 — `seed0006` comma-`U` @ ~3391+** — post-fifteenth tail / sixteenth **`movemon`** (~3391+); locator **3391–3420+**.
