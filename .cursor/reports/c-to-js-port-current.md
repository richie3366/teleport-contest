...
**Last slice:** **`roles.js`** + **`chargen_tty.js`** — C **`role.c`** **`role_selection_prolog`** as **`coerceChargenIndicesForRoleSelectionPrologLikeC`** (human-only role → human race; invalid race → **`STR2_RANDOM`**; role-forced gender; single allowed align; orc → chaotic). **`paintConfirmMenu`**: **`rigidRoleChecksJs(f)`** then prolog on a **shallow copy** for recap text only (no live **`f`** mutation — preserves core **RNG** prefix vs **`982c3c2`**). **`npm run score`:** **0/44**; **`seed0002`** **289/27158** RNG; **`seed0006`** **519/6736** RNG, **23/123** screens; **`seed0077`** **1507/3242** RNG, **11/33** screens; **`seed8000`** **2931/3130** RNG, **2/23** screens; **`seed0014`** **170/59178** RNG, **9/714** screens).
