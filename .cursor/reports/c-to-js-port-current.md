...
**Last slice:** **`u_init_role_rng.js`** + **`u_init_link_barbarian_invent.js`** — C **`u_init.c`** **`PM_BARBARIAN`**: **`rn2(100) >= 50`** **`Barbarian_0`** vs **`Barbarian_1`** (**`TWO_HANDED_SWORD`/`AXE`** vs **`BATTLE_AXE`/`SHORT_SWORD`**, **`mksobj_init`** keys **56**/**45**/**46**/**46**), **`RING_MAIL`**, food ration **`!rn2(6)`** quan, optional **`Lamp`** **`!rn2(6)`**; **`g._barbarianIniPack0`**, **`g._barbarianIniFoodQuan`**, **`g._barbarianIniLamp`**. **`applyBarbarianHumanLinkedInventAndWearLikeC`**: **`g.invent`**, **`uwep`/`uswapwep`/`uarm`**, **`findAc`**. **`fastforward_post_mklev`** human **`Bar`**; **`ini_inv_stub`** linker. **`npm run score`:** **0/44**; **`seed0373`** **278/35386** RNG; **`seed0002`** **357/27158**; **`seed0030`** **5221/105529**; **`seed0108`** **250/16958**; **`seed0116`** **322/12562**; **`seed0360`** **320/120639**; **`seed0006`** **280/6736**, **24/123**; **`seed0077`** **1507/3242**, **11/33**; **`seed0012`** **462/13878**, **12/308**; **`seed0004`** **539/12084**, **7/409**; **`seed1500`** **976/2768**; **`seed8000`** **2931/3130**, **2/23**; **`seed0014`** **170/59178**, **10/714**; **`seed0361`** **262/53865**.

## Next steps

1. **Chargen** — **`Cave_man[]`** (or next **`trobj[]`** role) **`ini_inv`** + **`fastforward`** + linker; refine **human Monk** / **Wizard** RNG (**`ini_inv_adjust_obj`** charged-ring **`rne(3)`** when **`spe<=0`**, blindfold/`trquan` edge parity) if sessions diverge; wire **`#pray`** / priest donation to **`divine_protection.js`**; **`seed0006`** / **`pick_*`**; **`u_init.c`** **`knows_object`** post–Samurai (no RNG) if discovery order matters.
