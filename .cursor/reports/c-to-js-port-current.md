...
**Last slice:** **`vision.js`** / **`allmain.js`** — C **`allmain.c`** **`newgame()`**: **`notice_mon_off()`** at start (before welcome); after welcome pline **`notice_mon_on()`** + **`notice_all_mons(TRUE)`** (C **`a11y.glyph_updates`** → **`dolookaround`** branch not ported). **`ensureA11yLikeC`** (**`struct accessibility_data`** subset: **`mon_notices`**, **`mon_notices_blocked`**, **`glyph_updates`**), **`noticeMonOffLikeC`** / **`noticeMonOnLikeC`** / **`noticeAllMonsLikeC`**; **`seeMonsters`** still stub (no-op when **`mon_notices`** false, default). **`npm run score`:** **0/44**; **`seed0006`** **519/6736** RNG, **23/123** screens; **`seed0012`** **405/13878** RNG, **12/308** screens; **`seed0077`** **1507/3242** RNG, **11/33** screens; **`seed8000`** **2931/3130** RNG, **2/23** screens; **`seed0014`** **170/59178** RNG, **9/714** screens.

## Next steps

1. **Chargen / tty + early game** — **`seed0006`** / **`seed0077`** remaining screen deltas (**`--More--`**, dungeon map, …); **`pick_*`** / **`rigid_role_checks`** if RNG still diverges mid-chargen. **`maybe_do_tutorial`**: **`findLevelTut1LikeC`** / tty **`select_menu`** when tut level exists (hook is in **`jsmain`** / **`moveloop_preamble.js`**).
