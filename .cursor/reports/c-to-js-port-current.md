...
**Last slice:** **P2 — comma-`U` sixteenth `movemon` + inline new-turn (`seed0006`)** — **`moveloop_turn_advance.js`**: post-fifteenth inline → sixteenth **`movemon`** (fix premature outer-loop done after fifteenth); **`monmove.js`**: sixteenth peel explicit (~3391–3422); **`moveloop_aux.js`**: **`runCommaUPostSixteenthInlineNewturnLikeC`**. Locator **`seed0006` 3391–3425**; fail **3426+** seventeenth **`movemon`**. Canaries **PASS**.
...
1. **P2 — `seed0006` comma-`U` @ ~3426+** — post-sixteenth tail / seventeenth **`movemon`** (~3426+); locator **3426–3450+**.
