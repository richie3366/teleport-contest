...
**Last slice:** **`u_init_link_valkyrie_invent.js`** + **`consumeValkyrieHumanIniInvUinitRoleRngLikeC`** — C **`u_init.c`** **`Valkyrie[]`** **`ini_inv`**: **`trquan`**/**`mksobj_init`** (spear **`OTYP_SPEAR_MK` 28**, dagger **34**, small shield armor init, food **`!rn2(6)`** stack, optional **`!rn2(6)`** **`Lamp[]`** oil **`rn1(500,1000)`** + **`blessorcurse(5)`**), linked **`g.invent`**, **`uwep`/`uswapwep`/`uarms`**, **`findAc`**. **`fastforward_post_mklev`** human Valkyrie branch. **`npm run score`:** **0/44**; **`seed0077`** **1507/3242** RNG, **11/33** screens; **`seed0002`** **351/27158**; **`seed0006`** **280/6736**, **24/123**; **`seed8000`** **2931/3130**, **2/23**; **`seed0014`** **170/59178**, **10/714**; **`seed1500`** **976/2768**; **`seed0015`** **359/8563**; **`seed0105`** **956/2499**; **`seed0017`** **325/3465**, **8/67**; **`seed0107`** **1102/2902**; **`seed0700`** **361/3230**; **`seed0030`** **5227/105529**.

## Next steps

1. **Chargen / tty + early game** — extend **`g.invent`** + **`fastforward`** role RNG to further roles (**`trobj`**); wire **`#pray`** / priest donation to **`divine_protection.js`**; **`seed0006`** / **`pick_*`**; Wizard **`ini_inv(Wizard[])`** + blindfold (**`UNDEF_TYP`** **`mkobj`** loops); **`u_init.c`** **`knows_object`** post–Samurai (no RNG) if discovery order matters.
