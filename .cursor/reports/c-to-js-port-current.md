...
**Last slice:** **Wizard `ini_inv_adjust_obj` charged rings** — C **`u_init.c`**: when **`trop->trspe == UNDEF_SPE`**, **`oc_charged`** ring with **`spe <= 0`** → **`rne(3)`**. **`mkobj_wizard_ini_inv_filter_like_c.js`**: **`mksobjInitRingLikeC`** returns **`spe`**, **`iniInvAdjustObjRingSpeUndefTropLikeC`**, **`takeLastIniInvRingMksobjSpeLikeC`**, pancake / non-ring paths clear ring **`spe`** stash. **`u_init_role_rng.js`**: after each accepted UNDEF ring in **`consumeWizardHumanIniInvUinitRoleRngLikeC`**. **`npm run score`:** **0/44**; listed seed anchors same as prior run (**`seed8000`** **2917/3130**, **1/23**; **`seed0030`** **5148/105529**; **`seed5006`** **564/13923**; **`seed1150`** **335/3137**; **`seed0373`** **278/35386**; **`seed0002`** **357/27158**; **`seed0108`** **250/16958**; **`seed0116`** **322/12562**; **`seed0360`** **320/120639**; **`seed0006`** **280/6736**, **24/123**; **`seed0077`** **1507/3242**, **11/33**; **`seed0012`** **462/13878**, **12/308**; **`seed0004`** **539/12084**, **7/409**; **`seed1500`** **976/2768**; **`seed0014`** **170/59178**, **10/714**; **`seed0361`** **262/53865**; **`seed0017`** **324/3465**, **8/67**; **`seed0700`** **358/3230**; **`seed0101`** **986/2371**; **`seed0102`** **1214/4485**; **`seed0106`** **343/4194**; **`seed0367`** **303/50125**; **`seed0501`** **273/2238**; **`seed0900`** **351/2983**; **`seed1800`** **285/2458**).

## Next steps

1. **Chargen** — FOOD ini-inv: wire **`mvitals`/`dead_species`** when **`egg`**/**`corpsenm`** state is modeled; wire **`#pray`** / priest donation to **`divine_protection.js`**; **`seed0006`** / **`pick_*`**; **`u_init.c`** **`knows_object`** post–Samurai if discovery order matters; **`ini_inv_adjust_obj`** remainder (e.g. fixed-**`trspe`** **`MAGIC_MARKER`** tail vs **`rn2(4)`** already split).
