...
**Last slice:** **`options.js`** — C **`options.c`** **`OPTIONS=tutorial:val`** (colon form): parse **`yes`/`no`/`on`/`off`/…** into boolean **`flags.tutorial`** and set **`tutorial_set`** so **`jsmain`** **`tutorial_set_in_config`** + **`askDoTutorialLikeC`** match **`opt_set_in_config[opt_tutorial]`** (was string **`val`**, so **`!!flags.tutorial`** wrongly treated **`tutorial:no`** as true). **`parseRcBooleanishLikeC`**. **`npm run score`:** **0/44**; **`seed0006`** **519/6736** RNG, **23/123** screens; **`seed0012`** **405/13878** RNG, **12/308** screens; **`seed0077`** **1507/3242** RNG, **11/33** screens; **`seed8000`** **2931/3130** RNG, **2/23** screens; **`seed0014`** **170/59178** RNG, **9/714** screens.
