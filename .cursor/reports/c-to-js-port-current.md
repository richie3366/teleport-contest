...
**Last slice:** **`mkobj_wizard_ini_inv_filter_like_c.js`** — C **`ini_inv_mkobj_filter`** for **`PM_CLERIC`**: **`clericSpellbookRestrictedLikeC`** (**`Skill_C[]`** — **`P_ATTACK_SPELL`** / **`P_MATTER_SPELL`** only), **`iniInvMkobjFilterPriestHumanLikeC`** (no wizard-only **`SPE_FORCE_BOLT`** reject). **`u_init_role_rng.js`**: **`consumePriestHumanIniInvUinitRoleRngLikeC`** — **`ini_inv(Priest[])`**: mace/shield/robe **`trquan`**/**`mksobj_init`**, **4×** holy water potion, garlic/wolfsbane FOOD default quan, **2×** UNDEF spellbook + **`got_level1_spellbook`** gate via **`SPELLBOOK_OTYP_LEVEL`**, **`!rn2(5)`** marker **`else if (!rn2(10))`** lamp. **`u_init_link_priest_invent.js`**: **`uwep`/`uarm`/`uarms`**, blessed mace/holy water, **`findAc`**. **`fastforward_post_mklev`** human **`Pri`**; **`ini_inv_stub`** linker. **`npm run score`:** **0/44**; **`seed1150`** **335/3137** RNG; **`seed0373`** **278/35386**; **`seed0002`** **357/27158**; **`seed0030`** **5205/105529**; **`seed0108`** **250/16958**; **`seed0116`** **322/12562**; **`seed0360`** **320/120639**; **`seed0006`** **280/6736**, **24/123**; **`seed0077`** **1507/3242**, **11/33**; **`seed0012`** **462/13878**, **12/308**; **`seed0004`** **539/12084**, **7/409**; **`seed1500`** **976/2768**; **`seed8000`** **2931/3130**, **2/23**; **`seed0014`** **170/59178**, **10/714**; **`seed0361`** **262/53865**; **`seed0017`** **324/3465**, **8/67**; **`seed0700`** **358/3230**; **`seed0101`** **986/2371**; **`seed0102`** **1214/4485**; **`seed0106`** **343/4194**; **`seed0367`** **303/50125**; **`seed0501`** **273/2238**.

## Next steps

1. **Chargen** — **`Tourist[]`** (**`rnd(1000)`** money + **`ini_inv`** darts/food/scroll/shirt/tools) + **`fastforward`** + linker; refine **human Monk** / **Wizard** RNG (**`ini_inv_adjust_obj`** charged-ring **`rne(3)`** when **`spe<=0`**, blindfold/`trquan` edge parity) if sessions diverge; wire **`#pray`** / priest donation to **`divine_protection.js`**; **`seed0006`** / **`pick_*`**; **`u_init.c`** **`knows_object`** post–Samurai (no RNG) if discovery order matters.
