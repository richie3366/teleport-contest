...
**Last slice:** **`u_init_link_knight_invent.js`** + **`consumeKnightHumanIniInvUinitRoleRngLikeC`** — C **`u_init.c`** **`Knight[]`** **`ini_inv`**: **`trquan`**/**`mksobj_init`** (long sword **`55`** / lance **`73`**, four armor inits, **`10+rn2(1)`** per apple/carrot trobj then **`next_ident`** + default FOOD **`!rn2(6)`** ×20), linked **`g.invent`** (apple **`otyp` 277**, carrot **282** per cpp **`OBJECTS_ENUM`** / **`OC_COST_BY_OTYP`**), **`uwep`/`uswapwep`/`uarm`/`uarmh`/`uarms`/`uarmg`**, **`findAc`**. **`u_init_role_rng.js`**: shared **`mksobjInitDefaultFoodQuanMaybeDoubleLikeC`** (same tail as ration). **`fastforward_post_mklev`** human Knight branch. **`npm run score`:** **0/44**; **`seed0077`** **1507/3242** RNG, **11/33** screens; **`seed0002`** **351/27158**; **`seed0006`** **280/6736**, **24/123**; **`seed8000`** **2931/3130**, **2/23**; **`seed0014`** **170/59178**, **10/714**; **`seed1500`** **976/2768**; **`seed0015`** **359/8563**; **`seed0105`** **956/2499**; **`seed0017`** **325/3465**, **8/67**; **`seed0107`** **1102/2902**; **`seed0700`** **361/3230**; **`seed0030`** **5227/105529**; **`seed0103`** **1192/2640**; **`seed0104`** **1270/3223**; **`seed4500`** **224/108275**.

## Next steps

1. **Chargen / tty + early game** — extend **`g.invent`** + **`fastforward`** to further roles (**`Monk[]`**, **`Wizard[]`** + **`UNDEF_TYP`** **`mkobj`** + blindfold, …); wire **`#pray`** / priest donation to **`divine_protection.js`**; **`seed0006`** / **`pick_*`**; **`u_init.c`** **`knows_object`** post–Samurai (no RNG) if discovery order matters.
