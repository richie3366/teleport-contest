...
**Last slice:** **`u_init_role_rng.js`** + **`u_init_link_archeologist_invent.js`** — C **`u_init.c`** **`Archeologist[]`** **`ini_inv`** + **`u_init_role`** **`PM_ARCHEOLOGIST`** optional **`Tinopener`** / **`Lamp`** / **`Magicmarker`** (**`if` / `else if`** chain). **`consumeArcheologistHumanIniInvUinitRoleRngLikeC`**: bullwhip **`mksobj_init`** (**`OC_SKILL`** key **83**), jacket/fedora armor, three food rations (**`Monk[]`**-style per-ration tail), **`PICK_AXE`** tool-only **`trquan`**, tinning **`rn1(70,30)`**, touchstone **`GEM_CLASS`** **`!rn2(6)`** draw ( **`ini_inv_adjust_obj`** forces stack **1**), sack **`mkbox_cnts`**, optional packs. **`applyArcheologistHumanLinkedInventAndWearLikeC`**: **`g.invent`**, **`uwep`**, **`u.uarmu`/`u.uarmh`**, **`findAc`**. **`fastforward_post_mklev`** human **`Arc`**; **`ini_inv_stub`** linker. **`npm run score`:** **0/44**; **`seed0361`** **262/53865** RNG; **`seed0030`** **5222/105529**; **`seed0108`** **250/16958**; **`seed0116`** **322/12562**; **`seed0360`** **320/120639**; **`seed0006`** **280/6736**, **24/123**; **`seed0077`** **1507/3242**, **11/33**; **`seed0002`** **351/27158**; **`seed0012`** **462/13878**, **12/308**; **`seed0004`** **539/12084**, **7/409**; **`seed1500`** **976/2768**; **`seed8000`** **2931/3130**, **2/23**; **`seed0014`** **170/59178**, **10/714**.

## Next steps

1. **Chargen** — **`Healer[]`** (next **`trobj[]`** role) **`ini_inv`** + **`fastforward`** + linker; refine **human Monk** / **Wizard** RNG (**`ini_inv_adjust_obj`** charged-ring **`rne(3)`** when **`spe<=0`**, blindfold/`trquan` edge parity) if sessions diverge; wire **`#pray`** / priest donation to **`divine_protection.js`**; **`seed0006`** / **`pick_*`**; **`u_init.c`** **`knows_object`** post–Samurai (no RNG) if discovery order matters.
