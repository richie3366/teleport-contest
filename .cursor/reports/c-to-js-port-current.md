...
**Last slice:** **Lane A/D `seed0900` run-east `L` post (~2680–2706)** — diag **2620–2706** match. Sixth **`movemon`** (invent + 2-phase **`mfndpos`**, 4× inter-phase **`distfleeck`**, tail away pad); sixth-specific phase-1 **`mfndpos`** branch; arm after fifth-pass new-turn. **Open:** **~2707** — seventh **`movemon`** (invent + **`mfndpos`**). **`seed8000`:** **PASS**. **2/44**.
...
1. **Lane A/D — `seed0900` ~2707** — seventh **`movemon`** ( **`distfleeck`** + 5× invent + **`mfndpos`** ~2707–2723). Diag **2707–2750**; mirror sixth-pass arm/skip pattern.
