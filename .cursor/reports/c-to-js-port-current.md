...
**Last slice:** **`u_init_role_rng.js`** + **`u_init_link_cave_dweller_invent.js`** — C **`u_init.c`** **`PM_CAVE_DWELLER`**: **`ini_inv(Cave_man[])`** — club **`+1`** / sling **`+2`** (**`mksobj_init`** **`WEAPON_CLASS`** leaf), **`10+rn2(11)`** × (**`next_ident`** + GEM **FLINT** **`!rn2(6)`** stack quan **1–2**), **`3+rn2(1)`** × (**`next_ident`** + **`ROCK`** **`rn1(6,6)`**), leather **`+0`**. **`g._caveIniNFlintTrobj`**, **`g._caveIniFlintQuan`**, **`g._caveIniNRockTrobj`**, **`g._caveIniRockQuan`**. **`applyCaveDwellerHumanLinkedInventAndWearLikeC`**: merged flint/rock stacks, **`uwep`/`uswapwep`/`uarm`/`uquiver`**, **`findAc`**. **`fastforward_post_mklev`** human **`Cav`**; **`ini_inv_stub`** linker. **`npm run score`:** **0/44**; **`seed1150`** **335/3137** RNG; **`seed0373`** **278/35386**; **`seed0002`** **357/27158**; **`seed0030`** **5221/105529**; **`seed0108`** **250/16958**; **`seed0116`** **322/12562**; **`seed0360`** **320/120639**; **`seed0006`** **280/6736**, **24/123**; **`seed0077`** **1507/3242**, **11/33**; **`seed0012`** **462/13878**, **12/308**; **`seed0004`** **539/12084**, **7/409**; **`seed1500`** **976/2768**; **`seed8000`** **2931/3130**, **2/23**; **`seed0014`** **170/59178**, **10/714**; **`seed0361`** **262/53865**.

## Next steps

1. **Chargen** — next **`trobj[]`** role (**`Ranger[]`**, **`Priest[]`**, …) **`ini_inv`** + **`fastforward`** + linker; refine **human Monk** / **Wizard** RNG (**`ini_inv_adjust_obj`** charged-ring **`rne(3)`** when **`spe<=0`**, blindfold/`trquan` edge parity) if sessions diverge; wire **`#pray`** / priest donation to **`divine_protection.js`**; **`seed0006`** / **`pick_*`**; **`u_init.c`** **`knows_object`** post–Samurai (no RNG) if discovery order matters.
