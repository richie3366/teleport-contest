...
**Last slice:** **`mkmaze.c`** **`makemaz`** protofile — **`resolveMakemazProtofileLikeC`** (**`rndlevs`**, dungeon **`proto`**); **`load_lua`** still deferred. **`seed0077`/`seed8000`:** **PASS**. **`npm run score`:** **2/44**.
