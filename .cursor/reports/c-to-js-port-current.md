...
**Last slice:** **Chargen tty cursor after text menus (`wintty.c` / `end_menu`)** — **`chargen_tty.js`**: **`setChargenEndMenuCursorLikeC`** — cursor at **startCol + line.length + 1** on the **`(end)`** row (C **seed0077**: role **`[7,23]`**, right-column menus **`[47,lastRow]`**). **`npm run score`:** **0/44**; **`seed0006`** **131/6736** RNG, **0/123** screens, **6/123** cursors; **`seed0077`** **1507/3242** RNG, **3/33** screens, **3/33** cells, **7/33** cursors; **`seed0012`** **405/13878** RNG, **1/308** screens; **`seed8000`** **2931/3130** RNG, **2/23** screens.

## Next steps

1. **Chargen / tty remainder** — Remaining **cell** diffs on chargen screens (text/SGR vs C **`wintty.c`** where not cursor-only); **`seed0006`** / **`seed0077`** next divergences after cursor fix.
