...
**Last slice:** **Batch 3** — deleted `_wizD1CommaPostNinth*` inline peel; post-ninth pass via `movemonSinglemonLikeC` (`mon.c`). `seed0006` 3175–3210 + three canaries aligned.
...
1. **P2 — PostTenth peel** — same pattern as batches 1–3; delete `_wizD1CommaPostTenth*` inline peel + `mons=[]` when `seed0006` ~3224–3245 + canaries pass. Oracle: [`c-oracles/monmove.c.md`](c-oracles/monmove.c.md).
