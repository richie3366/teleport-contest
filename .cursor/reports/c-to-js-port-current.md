...
**Last slice:** **`pray.c` `pleased`** — **`pat_on_head`** cases **1–4** (**`pray_hero.js`**: uwep uncurse/bless/repair; castle-tune **`u.uevent`** + **`g._castleTuneStr`** from **`fastforward.js`** **`init_castle_tune`**; golden glow / **`ulevelmax--`** + **`pluslvlHeroLikeC`** (**`exper_pluslvl.js`**: **`newhp`/`newpw`/`pluslvl`**); mass uncurse **`g.invent`**, skip cursed helm **otyp 100** on **`u.uarmh`**); **`pat_on_head`** cases **6–8** (**`give_spell`**/**`gcrownu`**) still TODO. **`hero_hands.js`**: export **`weldedUwepLikeC`**, **`isWeptoolObjLikeC`**. **`npm run score`:** **0/44**; **`seed0017`** **326/3465**, **8/67**; **`seed0106`** **339/4194**; **`seed0116`** **322/12562**; **`seed8000`** **2917/3130**, **1/23**.

## Next steps

1. **Chargen** — **`pray.c` `pleased`** remainder: **`pat_on_head`** cases **6–8** (**`give_spell`**, **`gcrownu`**); full **`fix_worst_trouble`**/**`in_trouble`**; **`angrygods`** **`punish(NULL)`**, **`summon_minion`**, **`god_zaps_you`**; wizard **`livelog`**; fuller **`sit.c`** (**`altar_wrath`**, **`dotrap`** **`VIASITTING`**, **`OBJ_AT`**, **`is_prince`** comfort, **`makewish`**/**`readobjnam`**, **`courtmon`**/**`mkclass`**, **`special_throne_effect`** wish/disintegrate parity); **`domonnoise`** beyond priest; full **`money2mon`** onto **`minvent`**; **`seed0006`** / **`pick_*`**; **`u_init.c`** **`knows_object`** post–Samurai if discovery order matters; extend **`mvitals`** past **`SPECIAL_PM`** when **`NUMMONS`**-sized **`mons[]` geno** is generated; **`ini_inv_adjust_obj`** remainder (fixed-**`trspe`** **`MAGIC_MARKER`** vs **`rn2(4)`** split already in role RNG).
