...
**Last slice:** **`chargen.js`** — C **`role.c`** **`role_init`** mirrors after **`coerceChargenIdentity`**: **`g.pl_character`** = **`roles[initrole].name.m`** (**`Strcpy(svp.pl_character, …)`**); **`g.initrole`**, **`g.initrace`**, **`g.initgend`**, **`g.initalign`** (**`aligns[]`** index) match coerced **`flags.init*`** layout for **`u_init`** / tooling. **`npm run score`:** **0/44**; **`seed0006`** **519/6736** RNG, **23/123** screens; **`seed0012`** **405/13878** RNG, **12/308** screens; **`seed0077`** **1507/3242** RNG, **11/33** screens; **`seed8000`** **2931/3130** RNG, **2/23** screens; **`seed0014`** **170/59178** RNG, **9/714** screens.
