...
**Last slice:** **`role.c`** **`plnamesuffix`** + **`str2role`/`str2race`/`str2gend`/`str2align`** — **`roles.js`** (**`str2*IndexLikeC`**, **`STR2_*`**, align/gender **`filecode`**/**`plPrefix`**); **`chargen.js`** **`applyPlnameSuffixToOptsLikeC`** + call from **`applyIdentityFromNethackrc`**; **`jsmain.js`** runs **`applyIdentityFromNethackrc`** **after** **`initRng`** so **`coerceChargenIdentity`** / suffix **`random`** draws match C **`role_init`** ordering. **`npm run score`:** **0/44**; **`seed0006`** **519/6736** RNG, **23/123** screens; **`seed0012`** **405/13878** RNG, **12/308** screens; **`seed0077`** **1507/3242** RNG, **11/33** screens; **`seed8000`** **2931/3130** RNG, **2/23** screens; **`seed0014`** **170/59178** RNG, **9/714** screens.
