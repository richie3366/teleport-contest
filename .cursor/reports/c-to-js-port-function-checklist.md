...
| C symbol / area | JS module | Status | Notes |
|-----------------|-----------|--------|-------|
| `movemon` / `dochug` | `monmove.js`, `fmon_iter.js`, `moveloop_turn_advance.js` | partial | **`L`** peel + tail + third + fourth **`movemon`**; skip **`mcalcmove`** after third/fourth passes; **`seed0900`** **2620–2654**; **~2655** open |
...
| `m_throw` | — | missing | |
| `dogmove` | `dogmove_mon.js` | partial | **`dogMoveTouristD1LPostFourthMovemonPetLikeC`** (5× invent + phase-1 **`mfndpos`**); third/tail helpers; **`seed0900`** **2620–2654**; **~2655** open |
