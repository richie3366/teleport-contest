...
| C symbol / area | JS module | Status | Notes |
|-----------------|-----------|--------|-------|
| `movemon` / `dochug` | `monmove.js`, `fmon_iter.js`, `moveloop_turn_advance.js`, `moveloop_aux.js`, `dogmove_mon.js`, `m_move_mon.js`, `monmove_search.js`, `mfndpos_mon.js`, `distfleeck_mon.js` | partial | Comma surplus **~3054–3583**: twelfth peel (~3263–3291 debt); thirteenth peel (~3296–3306 debt); fourteenth peel (~3310–3336 debt); fifteenth peel (~3340–3387 debt); sixteenth peel (~3391–3422 debt); seventeenth peel (~3426–3448 debt); eighteenth peel (~3452–3472 debt); nineteenth peel (~3476–3485 debt); twentieth peel (~3490–3504 debt); twenty-first peel (~3508–3524 debt); twenty-second peel (~3528–3544 debt); twenty-third peel (~3548–3580 debt); **`runCommaUPostTwelfthInlineNewturnLikeC`** … **`runCommaUPostTwentyThirdInlineNewturnLikeC`**; **`post_moveloop82_exercise(5)`** before thirteenth. Fail **3584+** twenty-fourth **`movemon`**. **`seed8000` 2900–3129** + canaries aligned |
...
| C symbol / area | JS module | Status | Notes |
|-----------------|-----------|--------|-------|
| `moveloop` / post-hero `movemon` | `moveloop_turn_advance.js`, `moveloop_aux.js` | partial | **`seed0006`** comma-**`U`**: twelfth…twenty-third inline new-turns + chained twenty-third **`movemon`**. Fail **3584+**. **`seed8000` 2900–3129:** aligned |
