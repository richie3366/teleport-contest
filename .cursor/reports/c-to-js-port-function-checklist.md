...
| `com_pager` / legacy intro | `legacy_intro.js`, `legacy_intro_paint.js`, `display.js` | partial | **`docrt`** after com_pager dismiss; **`shopInteriorRoomSeenvGlyphLikeC`** + **`syncMapDispColorsFromTerrainLikeC`** brown **`k`**; hdoor **(28,9)**/**(26,11)**; **`seed0102` screens 10/25**; **screen 5** **`#name`** row-0 open |
