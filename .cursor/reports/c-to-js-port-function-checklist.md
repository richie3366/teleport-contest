...
| C symbol / area | JS module | Status | Notes |
|-----------------|-----------|--------|-------|
| `movemon` / `dochug` | `monmove.js`, `fmon_iter.js`, `moveloop_turn_advance.js` | partial | **`L`** peel + tail + third … tenth **`movemon`**; skip **`mcalcmove`** after peel passes; **`seed0900`** **2620–2791**; **~2792** open |
...
| `m_throw` | — | missing | |
| `dogmove` | `dogmove_mon.js` | partial | fourth/sixth/seventh/eighth/ninth/tenth phase-1 **`mfndpos`**; seventh/eighth pair-pad; ninth 2× **`rn2(12)`** tail; tenth skip-floor + phase-2 budget 6 + phase-3; **`seed0900`** **2620–2791**; **~2792** open |
