...
| `u_init_role` RNG tail | `u_init_role_rng.js`, `u_init_post_mklev.js` | partial | **All roles** race-independent dispatch in `u_init_post_mklev.js`; Rog linker **`iniInvSubstOtypForChargenLikeC`**; orc **`Xtra_food`** invent link open |
