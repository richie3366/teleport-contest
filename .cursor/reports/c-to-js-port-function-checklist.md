...
| C symbol / area | JS module | Status | Notes |
|-----------------|-----------|--------|-------|
| `movemon` / `dochug` | `monmove.js`, `fmon_iter.js`, `moveloop_turn_advance.js` | partial | **`L`** peel + tail + third … thirteenth **`movemon`**; skip **`mcalcmove`** after peel passes; **`seed0900`** **2620–2849**; **~2850** open |
...
| `m_throw` | — | missing | |
| `dogmove` | `dogmove_mon.js` | partial | fourth/sixth/seventh/eighth/ninth/tenth/eleventh/thirteenth phase-1 **`mfndpos`**; seventh/eighth pair-pad; ninth/eleventh 2× **`rn2(12)`** tail; thirteenth **`chcnt`** + 3× tail; tenth/twelfth phase-2 budget 6 + phase-3; **`seed0900`** **2620–2849**; **~2850** open |
