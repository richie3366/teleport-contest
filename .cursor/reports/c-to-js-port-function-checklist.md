...
| C symbol / area | JS module | Status | Notes |
|-----------------|-----------|--------|-------|
| `movemon` / `dochug` | `monmove.js`, `fmon_iter.js`, `moveloop_turn_advance.js` | partial | **`L`** peel + tail + third … ninth **`movemon`**; skip **`mcalcmove`** after peel passes; **`seed0900`** **2620–2771**; **~2772** open |
...
| `m_throw` | — | missing | |
| `dogmove` | `dogmove_mon.js` | partial | fourth/sixth/seventh/eighth/ninth phase-1 **`mfndpos`**; seventh/eighth pair-pad; ninth 2× **`rn2(12)`** tail; **`seed0900`** **2620–2771**; **~2772** open |
