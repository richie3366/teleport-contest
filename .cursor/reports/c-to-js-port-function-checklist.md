...
| C symbol / area | JS module | Status | Notes |
|-----------------|-----------|--------|-------|
| `movemon` / `dochug` | `monmove.js`, `fmon_iter.js`, `moveloop_turn_advance.js`, `moveloop_aux.js`, `dogmove_mon.js`, `m_move_mon.js`, `monmove_search.js`, `mfndpos_mon.js`, `distfleeck_mon.js` | partial | Comma surplus **~3054–3475**: twelfth peel (~3263–3291 debt); thirteenth peel (~3296–3306 debt); fourteenth peel (~3310–3336 debt); fifteenth peel (~3340–3387 debt); sixteenth peel (~3391–3422 debt); seventeenth peel (~3426–3448 debt); eighteenth peel (~3452–3472 debt); **`runCommaUPostTwelfthInlineNewturnLikeC`** … **`runCommaUPostEighteenthInlineNewturnLikeC`**; **`post_moveloop82_exercise(5)`** before thirteenth. Fail **3476+** nineteenth **`movemon`**. **`seed8000` 2900–3129** + canaries aligned |
...
| C symbol / area | JS module | Status | Notes |
|-----------------|-----------|--------|-------|
| `moveloop` / post-hero `movemon` | `moveloop_turn_advance.js`, `moveloop_aux.js` | partial | **`seed0006`** comma-**`U`**: twelfth…eighteenth inline new-turns + chained eighteenth **`movemon`**. Fail **3476+**. **`seed8000` 2900–3129:** aligned |
