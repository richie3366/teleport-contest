...
| `com_pager` / legacy intro | `legacy_intro.js`, `legacy_intro_paint.js`, `display.js` | partial | Overlay on docrt map; west strip **20–22** + DEC **SO/SI** serialize; **`seed0102` screen 0** **PASS** |
