// dbridge.js — Drawbridge find / destroy (dig + zap callers).
// C ref: dbridge.c is_drawbridge_wall / find_drawbridge /
//        get_wall_for_db / destroy_drawbridge.
// Envelope (D-0959): terrain conversion + messages + wake + trap/engr
// clear + vision/stronghold flags; wire dig furniture_handled / dighole.
...
// liquid); nokiller; open/close_drawbridge callers beyond dig.
...
import {
    isok, u_at, IS_DRAWBRIDGE, DRAWBRIDGE_UP,
