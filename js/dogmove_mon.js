    ...
    for (let i = 0; i < cnt; i++) {
        ...
        if (g.context?._touristD1PostSwapAfterRestPetMfndposLikeC) {
            ...
            if (j > 0 && !whappr) {
                ...
                if (ctxAway._touristD1LPostSeventhMovemonLikeC) {
                    /* C: seventh pass — sameCell **`rn2(3)`** then **`rn2(12)`** (~2713–2722). */
                    if (sameCell) {
            ...
            const sixthPhase2Budget = ctxPeel._touristD1LPostSixthMovemonPhase2BudgetLikeC | 0;
...
export function dogMoveTouristD1LPostFourthMovemonPetLikeC(g, mtmp, phase = 1) {
        ...
        try {
            ...
            try {
                ...
                if (cached) {
                    ...
                    if (ctx._touristD1LPostSeventhMovemonLikeC) {
                        /* C: seventh — short **`mfndpos`** list; pair-pad **`rn2(3)`**+**`rn2(12)`**
                         * (~2719–2722 on **`seed0900`**). */
    ...
    try {
        ...
        const awayBudget =
            (ctx._touristD1LPostSixthMovemonPhase2BudgetLikeC | 0) > 0
