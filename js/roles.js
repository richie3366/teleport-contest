...
/** @type {RoleRow[]} */
export const roles = [
    { abbr: 'Arc', name: { m: 'Archeologist', f: 'Archeologist' }, rank: { m: 'Digger', f: 'Digger' }, mnum: 0, petnum: -1,
      ...
      ngod: 'Camaxtli',
      cgod: 'Huhetotl' },
    { abbr: 'Bar', name: { m: 'Barbarian', f: 'Barbarian' }, rank: { m: 'Plunderer', f: 'Plunderess' }, mnum: 1, petnum: -1,
      ...
      ngod: 'Crom',
      cgod: 'Set' },
    { abbr: 'Cav', name: { m: 'Caveman', f: 'Cavewoman' }, rank: { m: 'Troglodyte', f: 'Troglodyte' }, mnum: 2, petnum: 16,
      ...
      ngod: '_Ishtar',
      cgod: 'Anshar' },
    { abbr: 'Hea', name: { m: 'Healer', f: 'Healer' }, rank: { m: 'Rhizotomist', f: 'Rhizotomist' }, mnum: 3, petnum: -1,
      ...
      ngod: 'Hermes',
      cgod: 'Poseidon' },
    { abbr: 'Kni', name: { m: 'Knight', f: 'Knight' }, rank: { m: 'Gallant', f: 'Gallant' }, mnum: 4, petnum: 99,
    ...
    { abbr: 'Mon', name: { m: 'Monk', f: 'Monk' }, rank: { m: 'Candidate', f: 'Candidate' }, mnum: 5, petnum: -1,
      ...
      ngod: 'Chih Sung-tzu',
      cgod: 'Huan Ti' },
    { abbr: 'Pri', name: { m: 'Priest', f: 'Priestess' }, rank: { m: 'Aspirant', f: 'Aspirant' }, mnum: 6, petnum: -1,
      ...
      ngod: null,
      cgod: null },
    /* C role.c roles[] — Rogue precedes Ranger (`-R` retains Ranger meaning). */
    { abbr: 'Rog', name: { m: 'Rogue', f: 'Rogue' }, rank: { m: 'Footpad', f: 'Footpad' }, mnum: 7, petnum: -1,
      ...
      ngod: 'Mog',
      cgod: 'Kos' },
    { abbr: 'Ran', name: { m: 'Ranger', f: 'Ranger' }, rank: { m: 'Tenderfoot', f: 'Tenderfoot' }, mnum: 8, petnum: 16,
      ...
      ngod: '_Venus',
      cgod: 'Mars' },
    { abbr: 'Sam', name: { m: 'Samurai', f: 'Samurai' }, rank: { m: 'Hatamoto', f: 'Hatamoto' }, mnum: 9, petnum: 16,
      ...
      ngod: 'Raijin',
      cgod: 'Susanowo' },
    { abbr: 'Tou', name: { m: 'Tourist', f: 'Tourist' }, rank: { m: 'Rambler', f: 'Rambler' }, mnum: 10, petnum: -1,
      ...
      ngod: '_The Lady',
      cgod: 'Offler' },
    { abbr: 'Val', name: { m: 'Valkyrie', f: 'Valkyrie' }, rank: { m: 'Stripling', f: 'Stripling' }, mnum: 11, petnum: -1,
      ...
      ngod: 'Odin',
      cgod: 'Loki' },
    { abbr: 'Wiz', name: { m: 'Wizard', f: 'Wizard' }, rank: { m: 'Evoker', f: 'Evoker' }, mnum: 12, petnum: 34,
...
/** @type {RaceRow[]} */
export const races = [
    { name: 'human', adj: 'human', mnum: 0, selfmask: MH_HUMAN, lovemask: 0, hatemask: MH_GNOME | MH_ORC, filecode: 'Hum', permonst: permonstHuman,
      allows: { align: [1, 0, -1] },
    ...
    { name: 'elf', adj: 'elven', mnum: 1, selfmask: MH_ELF, lovemask: MH_ELF, hatemask: MH_ORC, filecode: 'Elf', permonst: permonstHuman,
      allows: { align: [-1] },
    ...
    { name: 'dwarf', adj: 'dwarven', mnum: 2, selfmask: MH_DWARF, lovemask: MH_DWARF | MH_GNOME, hatemask: MH_ORC, filecode: 'Dwa', permonst: permonstHuman,
      allows: { align: [1] },
      prologForcedAlignValueLikeC: 1,
    ...
    { name: 'gnome', adj: 'gnomish', mnum: 3, selfmask: MH_GNOME, lovemask: MH_DWARF | MH_GNOME, hatemask: MH_HUMAN, filecode: 'Gno', permonst: permonstHuman,
      allows: { align: [0] },
    ...
    { name: 'orc', adj: 'orcish', mnum: 4, selfmask: MH_ORC, lovemask: MH_ORC, hatemask: MH_HUMAN | MH_ELF | MH_DWARF, filecode: 'Orc', permonst: permonstHuman,
      allows: { align: [-1] },
      prologForcedAlignValueLikeC: -1,
